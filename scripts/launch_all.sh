...
open_t "NPC Traffic" "t3" "cd \"$CARLA_PATH/PythonAPI/examples\" && conda activate carla_env && PYTHONPATH=\"$CARLA_EGG:\$PYTHONPATH\" python3 generate_traffic.py -n 50 -w 10 --safe --asynch"
