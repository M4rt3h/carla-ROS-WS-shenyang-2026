...
class SpeedLimitNode(Node):
    def __init__(self):
        ...
        # --- Publishers ROS ---
        self._pub_speed = self.create_publisher(Image,  '/carla/perception/speed_sign', 10)
        self._pub_traffic_light = self.create_publisher(Image,  '/carla/perception/traffic_light',   10)
