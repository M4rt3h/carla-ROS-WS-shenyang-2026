...
namespace control
{
    class CarlaLqrPidControlPublisher: public rclcpp::Node
    {
        public:
            CarlaLqrPidControlPublisher();
            ~CarlaLqrPidControlPublisher() = default; //虚析构, 保证类安全继承
        ...
        private:
            ...
            std::unique_ptr<control::LqrController> lat_controller;
