...
void MrrStatusTempVolt__rosidl_typesupport_introspection_c__MrrStatusTempVolt_init_function(
...
void MrrStatusTempVolt__rosidl_typesupport_introspection_c__MrrStatusTempVolt_fini_function(void * message_memory)
{
  delphi_mrr_msgs__msg__MrrStatusTempVolt__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember MrrStatusTempVolt__rosidl_typesupport_introspection_c__MrrStatusTempVolt_message_member_array[9] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers MrrStatusTempVolt__rosidl_typesupport_introspection_c__MrrStatusTempVolt_message_members = {
  "delphi_mrr_msgs__msg",  // message namespace
  "MrrStatusTempVolt",  // message name
  9,  // number of fields
  sizeof(delphi_mrr_msgs__msg__MrrStatusTempVolt),
  MrrStatusTempVolt__rosidl_typesupport_introspection_c__MrrStatusTempVolt_message_member_array,  // message members
  MrrStatusTempVolt__rosidl_typesupport_introspection_c__MrrStatusTempVolt_init_function,  // function to initialize message memory (memory has to be allocated)
  MrrStatusTempVolt__rosidl_typesupport_introspection_c__MrrStatusTempVolt_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t MrrStatusTempVolt__rosidl_typesupport_introspection_c__MrrStatusTempVolt_message_type_support_handle = {
  0,
  &MrrStatusTempVolt__rosidl_typesupport_introspection_c__MrrStatusTempVolt_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, delphi_mrr_msgs, msg, MrrStatusTempVolt)() {
  MrrStatusTempVolt__rosidl_typesupport_introspection_c__MrrStatusTempVolt_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!MrrStatusTempVolt__rosidl_typesupport_introspection_c__MrrStatusTempVolt_message_type_support_handle.typesupport_identifier) {
    MrrStatusTempVolt__rosidl_typesupport_introspection_c__MrrStatusTempVolt_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &MrrStatusTempVolt__rosidl_typesupport_introspection_c__MrrStatusTempVolt_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
