...
void MrrDetection__rosidl_typesupport_introspection_c__MrrDetection_init_function(
...
void MrrDetection__rosidl_typesupport_introspection_c__MrrDetection_fini_function(void * message_memory)
{
  delphi_mrr_msgs__msg__MrrDetection__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember MrrDetection__rosidl_typesupport_introspection_c__MrrDetection_message_member_array[12] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers MrrDetection__rosidl_typesupport_introspection_c__MrrDetection_message_members = {
  "delphi_mrr_msgs__msg",  // message namespace
  "MrrDetection",  // message name
  12,  // number of fields
  sizeof(delphi_mrr_msgs__msg__MrrDetection),
  MrrDetection__rosidl_typesupport_introspection_c__MrrDetection_message_member_array,  // message members
  MrrDetection__rosidl_typesupport_introspection_c__MrrDetection_init_function,  // function to initialize message memory (memory has to be allocated)
  MrrDetection__rosidl_typesupport_introspection_c__MrrDetection_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t MrrDetection__rosidl_typesupport_introspection_c__MrrDetection_message_type_support_handle = {
  0,
  &MrrDetection__rosidl_typesupport_introspection_c__MrrDetection_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, delphi_mrr_msgs, msg, MrrDetection)() {
  MrrDetection__rosidl_typesupport_introspection_c__MrrDetection_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!MrrDetection__rosidl_typesupport_introspection_c__MrrDetection_message_type_support_handle.typesupport_identifier) {
    MrrDetection__rosidl_typesupport_introspection_c__MrrDetection_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &MrrDetection__rosidl_typesupport_introspection_c__MrrDetection_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
