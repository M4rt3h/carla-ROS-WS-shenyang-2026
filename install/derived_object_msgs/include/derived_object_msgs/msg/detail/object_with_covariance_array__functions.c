...
{
  derived_object_msgs__msg__ObjectWithCovarianceArray * msg = (derived_object_msgs__msg__ObjectWithCovarianceArray *)malloc(sizeof(derived_object_msgs__msg__ObjectWithCovarianceArray));
  if (!msg) {
    return NULL;
  }
...
derived_object_msgs__msg__ObjectWithCovarianceArray__Sequence__init(derived_object_msgs__msg__ObjectWithCovarianceArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (derived_object_msgs__msg__ObjectWithCovarianceArray *)calloc(size, sizeof(derived_object_msgs__msg__ObjectWithCovarianceArray));
    if (!data) {
      return false;
    }
...
{
  derived_object_msgs__msg__ObjectWithCovarianceArray__Sequence * array = (derived_object_msgs__msg__ObjectWithCovarianceArray__Sequence *)malloc(sizeof(derived_object_msgs__msg__ObjectWithCovarianceArray__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  derived_object_msgs__msg__ObjectWithCovarianceArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    derived_object_msgs__msg__ObjectWithCovarianceArray * data =
      (derived_object_msgs__msg__ObjectWithCovarianceArray *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!derived_object_msgs__msg__ObjectWithCovarianceArray__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          derived_object_msgs__msg__ObjectWithCovarianceArray__fini(&data[i]);
        }
        free(data);
        return false;
      }
