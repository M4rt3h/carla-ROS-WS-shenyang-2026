...
{
  mobileye_560_660_msgs__msg__FixedFoe * msg = (mobileye_560_660_msgs__msg__FixedFoe *)malloc(sizeof(mobileye_560_660_msgs__msg__FixedFoe));
  if (!msg) {
    return NULL;
  }
...
mobileye_560_660_msgs__msg__FixedFoe__Sequence__init(mobileye_560_660_msgs__msg__FixedFoe__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mobileye_560_660_msgs__msg__FixedFoe *)calloc(size, sizeof(mobileye_560_660_msgs__msg__FixedFoe));
    if (!data) {
      return false;
    }
...
{
  mobileye_560_660_msgs__msg__FixedFoe__Sequence * array = (mobileye_560_660_msgs__msg__FixedFoe__Sequence *)malloc(sizeof(mobileye_560_660_msgs__msg__FixedFoe__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  mobileye_560_660_msgs__msg__FixedFoe__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    mobileye_560_660_msgs__msg__FixedFoe * data =
      (mobileye_560_660_msgs__msg__FixedFoe *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mobileye_560_660_msgs__msg__FixedFoe__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          mobileye_560_660_msgs__msg__FixedFoe__fini(&data[i]);
        }
        free(data);
        return false;
      }
