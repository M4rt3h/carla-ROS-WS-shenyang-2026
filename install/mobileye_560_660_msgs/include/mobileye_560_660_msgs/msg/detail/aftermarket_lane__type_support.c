...
void AftermarketLane__rosidl_typesupport_introspection_c__AftermarketLane_init_function(
...
void AftermarketLane__rosidl_typesupport_introspection_c__AftermarketLane_fini_function(void * message_memory)
{
  mobileye_560_660_msgs__msg__AftermarketLane__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember AftermarketLane__rosidl_typesupport_introspection_c__AftermarketLane_message_member_array[9] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers AftermarketLane__rosidl_typesupport_introspection_c__AftermarketLane_message_members = {
  ...
  AftermarketLane__rosidl_typesupport_introspection_c__AftermarketLane_message_member_array,  // message members
  AftermarketLane__rosidl_typesupport_introspection_c__AftermarketLane_init_function,  // function to initialize message memory (memory has to be allocated)
  AftermarketLane__rosidl_typesupport_introspection_c__AftermarketLane_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t AftermarketLane__rosidl_typesupport_introspection_c__AftermarketLane_message_type_support_handle = {
  0,
  &AftermarketLane__rosidl_typesupport_introspection_c__AftermarketLane_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mobileye_560_660_msgs, msg, AftermarketLane)() {
  AftermarketLane__rosidl_typesupport_introspection_c__AftermarketLane_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!AftermarketLane__rosidl_typesupport_introspection_c__AftermarketLane_message_type_support_handle.typesupport_identifier) {
    AftermarketLane__rosidl_typesupport_introspection_c__AftermarketLane_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &AftermarketLane__rosidl_typesupport_introspection_c__AftermarketLane_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
