...
void LkaLane__rosidl_typesupport_introspection_c__LkaLane_init_function(
...
void LkaLane__rosidl_typesupport_introspection_c__LkaLane_fini_function(void * message_memory)
{
  mobileye_560_660_msgs__msg__LkaLane__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember LkaLane__rosidl_typesupport_introspection_c__LkaLane_message_member_array[11] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers LkaLane__rosidl_typesupport_introspection_c__LkaLane_message_members = {
  "mobileye_560_660_msgs__msg",  // message namespace
  "LkaLane",  // message name
  11,  // number of fields
  sizeof(mobileye_560_660_msgs__msg__LkaLane),
  LkaLane__rosidl_typesupport_introspection_c__LkaLane_message_member_array,  // message members
  LkaLane__rosidl_typesupport_introspection_c__LkaLane_init_function,  // function to initialize message memory (memory has to be allocated)
  LkaLane__rosidl_typesupport_introspection_c__LkaLane_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t LkaLane__rosidl_typesupport_introspection_c__LkaLane_message_type_support_handle = {
  0,
  &LkaLane__rosidl_typesupport_introspection_c__LkaLane_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mobileye_560_660_msgs, msg, LkaLane)() {
  LkaLane__rosidl_typesupport_introspection_c__LkaLane_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!LkaLane__rosidl_typesupport_introspection_c__LkaLane_message_type_support_handle.typesupport_identifier) {
    LkaLane__rosidl_typesupport_introspection_c__LkaLane_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &LkaLane__rosidl_typesupport_introspection_c__LkaLane_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
