...
void AhbcGradual__rosidl_typesupport_introspection_c__AhbcGradual_init_function(
...
void AhbcGradual__rosidl_typesupport_introspection_c__AhbcGradual_fini_function(void * message_memory)
{
  mobileye_560_660_msgs__msg__AhbcGradual__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember AhbcGradual__rosidl_typesupport_introspection_c__AhbcGradual_message_member_array[13] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers AhbcGradual__rosidl_typesupport_introspection_c__AhbcGradual_message_members = {
  "mobileye_560_660_msgs__msg",  // message namespace
  "AhbcGradual",  // message name
  13,  // number of fields
  sizeof(mobileye_560_660_msgs__msg__AhbcGradual),
  AhbcGradual__rosidl_typesupport_introspection_c__AhbcGradual_message_member_array,  // message members
  AhbcGradual__rosidl_typesupport_introspection_c__AhbcGradual_init_function,  // function to initialize message memory (memory has to be allocated)
  AhbcGradual__rosidl_typesupport_introspection_c__AhbcGradual_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t AhbcGradual__rosidl_typesupport_introspection_c__AhbcGradual_message_type_support_handle = {
  0,
  &AhbcGradual__rosidl_typesupport_introspection_c__AhbcGradual_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mobileye_560_660_msgs, msg, AhbcGradual)() {
  AhbcGradual__rosidl_typesupport_introspection_c__AhbcGradual_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!AhbcGradual__rosidl_typesupport_introspection_c__AhbcGradual_message_type_support_handle.typesupport_identifier) {
    AhbcGradual__rosidl_typesupport_introspection_c__AhbcGradual_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &AhbcGradual__rosidl_typesupport_introspection_c__AhbcGradual_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
