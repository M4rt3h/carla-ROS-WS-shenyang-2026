  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: mr_range
  {
    ...
    out << "mr_range: ";
    value_to_yaml(msg.mr_range, out);
    out << "\n";
  }
  ...
  // member: mr_range_rate
  {
    ...
    out << "mr_range_rate: ";
    value_to_yaml(msg.mr_range_rate, out);
    out << "\n";
  }
  ...
  // member: mr_angle
  {
    ...
    out << "mr_angle: ";
    value_to_yaml(msg.mr_angle, out);
    out << "\n";
  }
  ...
  // member: mr_power
  {
    ...
    out << "mr_power: ";
    value_to_yaml(msg.mr_power, out);
    out << "\n";
  }
