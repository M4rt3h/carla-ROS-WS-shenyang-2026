...
{
  carla_ackermann_msgs__msg__EgoVehicleControlStatus * msg = (carla_ackermann_msgs__msg__EgoVehicleControlStatus *)malloc(sizeof(carla_ackermann_msgs__msg__EgoVehicleControlStatus));
  if (!msg) {
    return NULL;
  }
...
carla_ackermann_msgs__msg__EgoVehicleControlStatus__Sequence__init(carla_ackermann_msgs__msg__EgoVehicleControlStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_ackermann_msgs__msg__EgoVehicleControlStatus *)calloc(size, sizeof(carla_ackermann_msgs__msg__EgoVehicleControlStatus));
    if (!data) {
      return false;
    }
...
{
  carla_ackermann_msgs__msg__EgoVehicleControlStatus__Sequence * array = (carla_ackermann_msgs__msg__EgoVehicleControlStatus__Sequence *)malloc(sizeof(carla_ackermann_msgs__msg__EgoVehicleControlStatus__Sequence));
  if (!array) {
    return NULL;
  }
