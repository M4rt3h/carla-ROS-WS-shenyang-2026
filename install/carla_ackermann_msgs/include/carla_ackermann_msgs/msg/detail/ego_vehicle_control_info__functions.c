...
{
  carla_ackermann_msgs__msg__EgoVehicleControlInfo * msg = (carla_ackermann_msgs__msg__EgoVehicleControlInfo *)malloc(sizeof(carla_ackermann_msgs__msg__EgoVehicleControlInfo));
  if (!msg) {
    return NULL;
  }
...
carla_ackermann_msgs__msg__EgoVehicleControlInfo__Sequence__init(carla_ackermann_msgs__msg__EgoVehicleControlInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_ackermann_msgs__msg__EgoVehicleControlInfo *)calloc(size, sizeof(carla_ackermann_msgs__msg__EgoVehicleControlInfo));
    if (!data) {
      return false;
    }
...
{
  carla_ackermann_msgs__msg__EgoVehicleControlInfo__Sequence * array = (carla_ackermann_msgs__msg__EgoVehicleControlInfo__Sequence *)malloc(sizeof(carla_ackermann_msgs__msg__EgoVehicleControlInfo__Sequence));
  if (!array) {
    return NULL;
  }
