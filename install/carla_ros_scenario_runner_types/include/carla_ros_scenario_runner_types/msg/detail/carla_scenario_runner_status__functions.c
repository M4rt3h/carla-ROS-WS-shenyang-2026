...
{
  carla_ros_scenario_runner_types__msg__CarlaScenarioRunnerStatus * msg = (carla_ros_scenario_runner_types__msg__CarlaScenarioRunnerStatus *)malloc(sizeof(carla_ros_scenario_runner_types__msg__CarlaScenarioRunnerStatus));
  if (!msg) {
    return NULL;
  }
...
carla_ros_scenario_runner_types__msg__CarlaScenarioRunnerStatus__Sequence__init(carla_ros_scenario_runner_types__msg__CarlaScenarioRunnerStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_ros_scenario_runner_types__msg__CarlaScenarioRunnerStatus *)calloc(size, sizeof(carla_ros_scenario_runner_types__msg__CarlaScenarioRunnerStatus));
    if (!data) {
      return false;
    }
...
{
  carla_ros_scenario_runner_types__msg__CarlaScenarioRunnerStatus__Sequence * array = (carla_ros_scenario_runner_types__msg__CarlaScenarioRunnerStatus__Sequence *)malloc(sizeof(carla_ros_scenario_runner_types__msg__CarlaScenarioRunnerStatus__Sequence));
  if (!array) {
    return NULL;
  }
