...
{
  carla_waypoint_types__srv__GetWaypoint_Request * msg = (carla_waypoint_types__srv__GetWaypoint_Request *)malloc(sizeof(carla_waypoint_types__srv__GetWaypoint_Request));
  if (!msg) {
    return NULL;
  }
...
carla_waypoint_types__srv__GetWaypoint_Request__Sequence__init(carla_waypoint_types__srv__GetWaypoint_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_waypoint_types__srv__GetWaypoint_Request *)calloc(size, sizeof(carla_waypoint_types__srv__GetWaypoint_Request));
    if (!data) {
      return false;
    }
...
{
  carla_waypoint_types__srv__GetWaypoint_Request__Sequence * array = (carla_waypoint_types__srv__GetWaypoint_Request__Sequence *)malloc(sizeof(carla_waypoint_types__srv__GetWaypoint_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  carla_waypoint_types__srv__GetWaypoint_Response * msg = (carla_waypoint_types__srv__GetWaypoint_Response *)malloc(sizeof(carla_waypoint_types__srv__GetWaypoint_Response));
  if (!msg) {
    return NULL;
  }
...
carla_waypoint_types__srv__GetWaypoint_Response__Sequence__init(carla_waypoint_types__srv__GetWaypoint_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_waypoint_types__srv__GetWaypoint_Response *)calloc(size, sizeof(carla_waypoint_types__srv__GetWaypoint_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  carla_waypoint_types__srv__GetWaypoint_Response__Sequence * array = (carla_waypoint_types__srv__GetWaypoint_Response__Sequence *)malloc(sizeof(carla_waypoint_types__srv__GetWaypoint_Response__Sequence));
  if (!array) {
    return NULL;
  }
