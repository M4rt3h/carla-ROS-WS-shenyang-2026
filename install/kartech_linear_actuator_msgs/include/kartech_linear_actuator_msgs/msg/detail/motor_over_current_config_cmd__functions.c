...
{
  kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd * msg = (kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd *)malloc(sizeof(kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd));
  if (!msg) {
    return NULL;
  }
...
kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd__Sequence__init(kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd *)calloc(size, sizeof(kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd));
    if (!data) {
      return false;
    }
...
{
  kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd__Sequence * array = (kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd__Sequence *)malloc(sizeof(kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd * data =
      (kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kartech_linear_actuator_msgs__msg__MotorOverCurrentConfigCmd__fini(&data[i]);
        }
        free(data);
        return false;
      }
