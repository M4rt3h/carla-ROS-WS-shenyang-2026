...
{
  kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd * msg = (kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd *)malloc(sizeof(kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd));
  if (!msg) {
    return NULL;
  }
...
kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd__Sequence__init(kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd *)calloc(size, sizeof(kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd));
    if (!data) {
      return false;
    }
...
{
  kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd__Sequence * array = (kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd__Sequence *)malloc(sizeof(kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd * data =
      (kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kartech_linear_actuator_msgs__msg__ConfigureOutputsPwmFreqCmd__fini(&data[i]);
        }
        free(data);
        return false;
      }
