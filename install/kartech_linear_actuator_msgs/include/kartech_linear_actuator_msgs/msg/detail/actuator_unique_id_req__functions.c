...
{
  kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq * msg = (kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq *)malloc(sizeof(kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq));
  if (!msg) {
    return NULL;
  }
...
kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq__Sequence__init(kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq *)calloc(size, sizeof(kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq));
    if (!data) {
      return false;
    }
...
{
  kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq__Sequence * array = (kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq__Sequence *)malloc(sizeof(kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq * data =
      (kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kartech_linear_actuator_msgs__msg__ActuatorUniqueIdReq__fini(&data[i]);
        }
        free(data);
        return false;
      }
