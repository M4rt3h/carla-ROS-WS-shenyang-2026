...
static rosidl_typesupport_introspection_c__MessageMember PositionCmd__rosidl_typesupport_introspection_c__PositionCmd_message_member_array[6] = {
  {
    "header",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kartech_linear_actuator_msgs, msg, PositionCmd)() {
  PositionCmd__rosidl_typesupport_introspection_c__PositionCmd_message_member_array[0].members_ =
