...
{
  kartech_linear_actuator_msgs__msg__AutoZeroCalCmd * msg = (kartech_linear_actuator_msgs__msg__AutoZeroCalCmd *)malloc(sizeof(kartech_linear_actuator_msgs__msg__AutoZeroCalCmd));
  if (!msg) {
    return NULL;
  }
...
kartech_linear_actuator_msgs__msg__AutoZeroCalCmd__Sequence__init(kartech_linear_actuator_msgs__msg__AutoZeroCalCmd__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kartech_linear_actuator_msgs__msg__AutoZeroCalCmd *)calloc(size, sizeof(kartech_linear_actuator_msgs__msg__AutoZeroCalCmd));
    if (!data) {
      return false;
    }
...
{
  kartech_linear_actuator_msgs__msg__AutoZeroCalCmd__Sequence * array = (kartech_linear_actuator_msgs__msg__AutoZeroCalCmd__Sequence *)malloc(sizeof(kartech_linear_actuator_msgs__msg__AutoZeroCalCmd__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  kartech_linear_actuator_msgs__msg__AutoZeroCalCmd__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kartech_linear_actuator_msgs__msg__AutoZeroCalCmd * data =
      (kartech_linear_actuator_msgs__msg__AutoZeroCalCmd *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kartech_linear_actuator_msgs__msg__AutoZeroCalCmd__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kartech_linear_actuator_msgs__msg__AutoZeroCalCmd__fini(&data[i]);
        }
        free(data);
        return false;
      }
