...
{
  ibeo_msgs__msg__Point2Dui * msg = (ibeo_msgs__msg__Point2Dui *)malloc(sizeof(ibeo_msgs__msg__Point2Dui));
  if (!msg) {
    return NULL;
  }
...
ibeo_msgs__msg__Point2Dui__Sequence__init(ibeo_msgs__msg__Point2Dui__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ibeo_msgs__msg__Point2Dui *)calloc(size, sizeof(ibeo_msgs__msg__Point2Dui));
    if (!data) {
      return false;
    }
...
{
  ibeo_msgs__msg__Point2Dui__Sequence * array = (ibeo_msgs__msg__Point2Dui__Sequence *)malloc(sizeof(ibeo_msgs__msg__Point2Dui__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  ibeo_msgs__msg__Point2Dui__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ibeo_msgs__msg__Point2Dui * data =
      (ibeo_msgs__msg__Point2Dui *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ibeo_msgs__msg__Point2Dui__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ibeo_msgs__msg__Point2Dui__fini(&data[i]);
        }
        free(data);
        return false;
      }
