...
void ScanPoint2202__rosidl_typesupport_introspection_c__ScanPoint2202_init_function(
...
void ScanPoint2202__rosidl_typesupport_introspection_c__ScanPoint2202_fini_function(void * message_memory)
{
  ibeo_msgs__msg__ScanPoint2202__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ScanPoint2202__rosidl_typesupport_introspection_c__ScanPoint2202_message_member_array[9] = {
  {
    "layer",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers ScanPoint2202__rosidl_typesupport_introspection_c__ScanPoint2202_message_members = {
  "ibeo_msgs__msg",  // message namespace
  "ScanPoint2202",  // message name
  9,  // number of fields
  sizeof(ibeo_msgs__msg__ScanPoint2202),
  ScanPoint2202__rosidl_typesupport_introspection_c__ScanPoint2202_message_member_array,  // message members
  ScanPoint2202__rosidl_typesupport_introspection_c__ScanPoint2202_init_function,  // function to initialize message memory (memory has to be allocated)
  ScanPoint2202__rosidl_typesupport_introspection_c__ScanPoint2202_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ScanPoint2202__rosidl_typesupport_introspection_c__ScanPoint2202_message_type_support_handle = {
  0,
  &ScanPoint2202__rosidl_typesupport_introspection_c__ScanPoint2202_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ibeo_msgs, msg, ScanPoint2202)() {
  if (!ScanPoint2202__rosidl_typesupport_introspection_c__ScanPoint2202_message_type_support_handle.typesupport_identifier) {
    ScanPoint2202__rosidl_typesupport_introspection_c__ScanPoint2202_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ScanPoint2202__rosidl_typesupport_introspection_c__ScanPoint2202_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
