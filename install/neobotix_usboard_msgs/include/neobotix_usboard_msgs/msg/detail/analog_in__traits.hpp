  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: analog_data_ch4_low_byte
  {
    ...
    value_to_yaml(msg.analog_data_ch4_low_byte, out);
    out << "\n";
  }
  ...
  // member: analog_data_ch4_high_bits
  {
    ...
    value_to_yaml(msg.analog_data_ch4_high_bits, out);
    out << "\n";
  }
  ...
  // member: analog_data_ch3_low_byte
  {
    ...
    value_to_yaml(msg.analog_data_ch3_low_byte, out);
    out << "\n";
  }
  ...
  // member: analog_data_ch3_high_bits
  {
    ...
    value_to_yaml(msg.analog_data_ch3_high_bits, out);
    out << "\n";
  }
  ...
  // member: analog_data_ch2_low_byte
  {
    ...
    value_to_yaml(msg.analog_data_ch2_low_byte, out);
    out << "\n";
  }
  ...
  // member: analog_data_ch2_high_bits
  {
    ...
    value_to_yaml(msg.analog_data_ch2_high_bits, out);
    out << "\n";
  }
  ...
  // member: analog_data_ch1_low_byte
  {
    ...
    value_to_yaml(msg.analog_data_ch1_low_byte, out);
    out << "\n";
  }
  ...
  // member: analog_data_ch1_high_bits
  {
    ...
    value_to_yaml(msg.analog_data_ch1_high_bits, out);
    out << "\n";
  }
