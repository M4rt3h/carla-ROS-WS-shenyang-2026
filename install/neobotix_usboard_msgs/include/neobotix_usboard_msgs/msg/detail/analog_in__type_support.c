...
void AnalogIn__rosidl_typesupport_introspection_c__AnalogIn_init_function(
...
void AnalogIn__rosidl_typesupport_introspection_c__AnalogIn_fini_function(void * message_memory)
{
  neobotix_usboard_msgs__msg__AnalogIn__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember AnalogIn__rosidl_typesupport_introspection_c__AnalogIn_message_member_array[10] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers AnalogIn__rosidl_typesupport_introspection_c__AnalogIn_message_members = {
  "neobotix_usboard_msgs__msg",  // message namespace
  "AnalogIn",  // message name
  10,  // number of fields
  sizeof(neobotix_usboard_msgs__msg__AnalogIn),
  AnalogIn__rosidl_typesupport_introspection_c__AnalogIn_message_member_array,  // message members
  AnalogIn__rosidl_typesupport_introspection_c__AnalogIn_init_function,  // function to initialize message memory (memory has to be allocated)
  AnalogIn__rosidl_typesupport_introspection_c__AnalogIn_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t AnalogIn__rosidl_typesupport_introspection_c__AnalogIn_message_type_support_handle = {
  0,
  &AnalogIn__rosidl_typesupport_introspection_c__AnalogIn_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, neobotix_usboard_msgs, msg, AnalogIn)() {
  AnalogIn__rosidl_typesupport_introspection_c__AnalogIn_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!AnalogIn__rosidl_typesupport_introspection_c__AnalogIn_message_type_support_handle.typesupport_identifier) {
    AnalogIn__rosidl_typesupport_introspection_c__AnalogIn_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &AnalogIn__rosidl_typesupport_introspection_c__AnalogIn_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
