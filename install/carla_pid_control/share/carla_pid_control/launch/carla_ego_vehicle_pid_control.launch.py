...
def generate_launch_description():
    ...
    pid_control_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('carla_pid_control'), 'launch', 'carla_stanley_pid_control.launch.py')
        )
    )
    ...
    return LaunchDescription(launch_args + [
        ...
        TimerAction(period=5.0, actions=[pid_control_launch]),        
