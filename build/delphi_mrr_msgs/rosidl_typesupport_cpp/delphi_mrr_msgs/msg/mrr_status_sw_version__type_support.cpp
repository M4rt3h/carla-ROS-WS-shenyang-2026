...
static const _MrrStatusSwVersion_type_support_symbol_names_t _MrrStatusSwVersion_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, delphi_mrr_msgs, msg, MrrStatusSwVersion)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, delphi_mrr_msgs, msg, MrrStatusSwVersion)),
  }
};
...
{
  return &::delphi_mrr_msgs::msg::rosidl_typesupport_cpp::MrrStatusSwVersion_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, delphi_mrr_msgs, msg, MrrStatusSwVersion)() {
  return get_message_type_support_handle<delphi_mrr_msgs::msg::MrrStatusSwVersion>();
}
