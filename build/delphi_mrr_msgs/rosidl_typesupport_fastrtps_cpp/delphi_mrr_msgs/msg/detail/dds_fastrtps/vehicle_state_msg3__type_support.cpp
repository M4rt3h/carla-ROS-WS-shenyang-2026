...
#include "delphi_mrr_msgs/msg/detail/vehicle_state_msg3__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const delphi_mrr_msgs::msg::VehicleStateMsg3 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<delphi_mrr_msgs::msg::VehicleStateMsg3 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VehicleStateMsg3__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const delphi_mrr_msgs::msg::VehicleStateMsg3 *>(
...
{
  return max_serialized_size_VehicleStateMsg3(full_bounded, 0);
}

static message_type_support_callbacks_t _VehicleStateMsg3__callbacks = {
  "delphi_mrr_msgs::msg",
  "VehicleStateMsg3",
...
static rosidl_message_type_support_t _VehicleStateMsg3__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VehicleStateMsg3__callbacks,
...
{
  return &delphi_mrr_msgs::msg::typesupport_fastrtps_cpp::_VehicleStateMsg3__handle;
}
