...
#include "delphi_mrr_msgs/msg/detail/mrr_status_sw_version__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const delphi_mrr_msgs::msg::MrrStatusSwVersion *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<delphi_mrr_msgs::msg::MrrStatusSwVersion *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MrrStatusSwVersion__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const delphi_mrr_msgs::msg::MrrStatusSwVersion *>(
...
{
  return max_serialized_size_MrrStatusSwVersion(full_bounded, 0);
}

static message_type_support_callbacks_t _MrrStatusSwVersion__callbacks = {
  "delphi_mrr_msgs::msg",
  "MrrStatusSwVersion",
...
static rosidl_message_type_support_t _MrrStatusSwVersion__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MrrStatusSwVersion__callbacks,
...
{
  return &delphi_mrr_msgs::msg::typesupport_fastrtps_cpp::_MrrStatusSwVersion__handle;
}
