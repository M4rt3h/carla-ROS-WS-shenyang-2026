...
#include "delphi_mrr_msgs/msg/detail/mrr_header_alignment_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const delphi_mrr_msgs::msg::MrrHeaderAlignmentState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<delphi_mrr_msgs::msg::MrrHeaderAlignmentState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MrrHeaderAlignmentState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const delphi_mrr_msgs::msg::MrrHeaderAlignmentState *>(
...
{
  return max_serialized_size_MrrHeaderAlignmentState(full_bounded, 0);
}

static message_type_support_callbacks_t _MrrHeaderAlignmentState__callbacks = {
  "delphi_mrr_msgs::msg",
...
static rosidl_message_type_support_t _MrrHeaderAlignmentState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MrrHeaderAlignmentState__callbacks,
...
{
  return &delphi_mrr_msgs::msg::typesupport_fastrtps_cpp::_MrrHeaderAlignmentState__handle;
}
