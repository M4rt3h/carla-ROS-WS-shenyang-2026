...
void VehicleStateMsg1__rosidl_typesupport_introspection_c__VehicleStateMsg1_init_function(
...
void VehicleStateMsg1__rosidl_typesupport_introspection_c__VehicleStateMsg1_fini_function(void * message_memory)
{
  delphi_mrr_msgs__msg__VehicleStateMsg1__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember VehicleStateMsg1__rosidl_typesupport_introspection_c__VehicleStateMsg1_message_member_array[16] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers VehicleStateMsg1__rosidl_typesupport_introspection_c__VehicleStateMsg1_message_members = {
  "delphi_mrr_msgs__msg",  // message namespace
  "VehicleStateMsg1",  // message name
  16,  // number of fields
  sizeof(delphi_mrr_msgs__msg__VehicleStateMsg1),
  VehicleStateMsg1__rosidl_typesupport_introspection_c__VehicleStateMsg1_message_member_array,  // message members
  VehicleStateMsg1__rosidl_typesupport_introspection_c__VehicleStateMsg1_init_function,  // function to initialize message memory (memory has to be allocated)
  VehicleStateMsg1__rosidl_typesupport_introspection_c__VehicleStateMsg1_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t VehicleStateMsg1__rosidl_typesupport_introspection_c__VehicleStateMsg1_message_type_support_handle = {
  0,
  &VehicleStateMsg1__rosidl_typesupport_introspection_c__VehicleStateMsg1_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, delphi_mrr_msgs, msg, VehicleStateMsg1)() {
  VehicleStateMsg1__rosidl_typesupport_introspection_c__VehicleStateMsg1_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!VehicleStateMsg1__rosidl_typesupport_introspection_c__VehicleStateMsg1_message_type_support_handle.typesupport_identifier) {
    VehicleStateMsg1__rosidl_typesupport_introspection_c__VehicleStateMsg1_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &VehicleStateMsg1__rosidl_typesupport_introspection_c__VehicleStateMsg1_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
