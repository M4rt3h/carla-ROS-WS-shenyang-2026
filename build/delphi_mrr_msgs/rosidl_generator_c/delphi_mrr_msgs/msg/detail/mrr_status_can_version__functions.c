...
{
  delphi_mrr_msgs__msg__MrrStatusCanVersion * msg = (delphi_mrr_msgs__msg__MrrStatusCanVersion *)malloc(sizeof(delphi_mrr_msgs__msg__MrrStatusCanVersion));
  if (!msg) {
    return NULL;
  }
...
delphi_mrr_msgs__msg__MrrStatusCanVersion__Sequence__init(delphi_mrr_msgs__msg__MrrStatusCanVersion__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (delphi_mrr_msgs__msg__MrrStatusCanVersion *)calloc(size, sizeof(delphi_mrr_msgs__msg__MrrStatusCanVersion));
    if (!data) {
      return false;
    }
...
{
  delphi_mrr_msgs__msg__MrrStatusCanVersion__Sequence * array = (delphi_mrr_msgs__msg__MrrStatusCanVersion__Sequence *)malloc(sizeof(delphi_mrr_msgs__msg__MrrStatusCanVersion__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  delphi_mrr_msgs__msg__MrrStatusCanVersion__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    delphi_mrr_msgs__msg__MrrStatusCanVersion * data =
      (delphi_mrr_msgs__msg__MrrStatusCanVersion *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!delphi_mrr_msgs__msg__MrrStatusCanVersion__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          delphi_mrr_msgs__msg__MrrStatusCanVersion__fini(&data[i]);
        }
        free(data);
        return false;
      }
