...
{
  delphi_mrr_msgs__msg__MrrControlMsgFR * msg = (delphi_mrr_msgs__msg__MrrControlMsgFR *)malloc(sizeof(delphi_mrr_msgs__msg__MrrControlMsgFR));
  if (!msg) {
    return NULL;
  }
...
delphi_mrr_msgs__msg__MrrControlMsgFR__Sequence__init(delphi_mrr_msgs__msg__MrrControlMsgFR__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (delphi_mrr_msgs__msg__MrrControlMsgFR *)calloc(size, sizeof(delphi_mrr_msgs__msg__MrrControlMsgFR));
    if (!data) {
      return false;
    }
...
{
  delphi_mrr_msgs__msg__MrrControlMsgFR__Sequence * array = (delphi_mrr_msgs__msg__MrrControlMsgFR__Sequence *)malloc(sizeof(delphi_mrr_msgs__msg__MrrControlMsgFR__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  delphi_mrr_msgs__msg__MrrControlMsgFR__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    delphi_mrr_msgs__msg__MrrControlMsgFR * data =
      (delphi_mrr_msgs__msg__MrrControlMsgFR *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!delphi_mrr_msgs__msg__MrrControlMsgFR__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          delphi_mrr_msgs__msg__MrrControlMsgFR__fini(&data[i]);
        }
        free(data);
        return false;
      }
