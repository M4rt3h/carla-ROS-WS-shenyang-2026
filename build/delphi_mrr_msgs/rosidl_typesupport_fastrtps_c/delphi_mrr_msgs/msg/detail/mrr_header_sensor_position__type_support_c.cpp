...
#include "delphi_mrr_msgs/msg/detail/mrr_header_sensor_position__rosidl_typesupport_fastrtps_c.h"
...
using _MrrHeaderSensorPosition__ros_msg_type = delphi_mrr_msgs__msg__MrrHeaderSensorPosition;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MrrHeaderSensorPosition__ros_msg_type * ros_message = static_cast<const _MrrHeaderSensorPosition__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: can_sensor_polarity
  {
    cdr << (ros_message->can_sensor_polarity ? true : false);
  }

  // Field name: can_sensor_lat_offset
  {
    cdr << ros_message->can_sensor_lat_offset;
  }

  // Field name: can_sensor_long_offset
  {
    cdr << ros_message->can_sensor_long_offset;
  }

  // Field name: can_sensor_hangle_offset
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MrrHeaderSensorPosition__ros_msg_type * ros_message = static_cast<_MrrHeaderSensorPosition__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _MrrHeaderSensorPosition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_delphi_mrr_msgs__msg__MrrHeaderSensorPosition(
...
{
  return max_serialized_size_delphi_mrr_msgs__msg__MrrHeaderSensorPosition(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_MrrHeaderSensorPosition = {
  "delphi_mrr_msgs::msg",
...
static rosidl_message_type_support_t _MrrHeaderSensorPosition__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MrrHeaderSensorPosition,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, delphi_mrr_msgs, msg, MrrHeaderSensorPosition)() {
  return &_MrrHeaderSensorPosition__type_support;
}
