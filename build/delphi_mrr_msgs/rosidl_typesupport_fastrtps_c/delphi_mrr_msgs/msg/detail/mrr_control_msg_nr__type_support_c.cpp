...
#include "delphi_mrr_msgs/msg/detail/mrr_control_msg_nr__rosidl_typesupport_fastrtps_c.h"
...
using _MrrControlMsgNR__ros_msg_type = delphi_mrr_msgs__msg__MrrControlMsgNR;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MrrControlMsgNR__ros_msg_type * ros_message = static_cast<const _MrrControlMsgNR__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MrrControlMsgNR__ros_msg_type * ros_message = static_cast<_MrrControlMsgNR__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _MrrControlMsgNR__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_delphi_mrr_msgs__msg__MrrControlMsgNR(
...
{
  return max_serialized_size_delphi_mrr_msgs__msg__MrrControlMsgNR(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_MrrControlMsgNR = {
  "delphi_mrr_msgs::msg",
  "MrrControlMsgNR",
...
static rosidl_message_type_support_t _MrrControlMsgNR__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MrrControlMsgNR,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, delphi_mrr_msgs, msg, MrrControlMsgNR)() {
  return &_MrrControlMsgNR__type_support;
}
