...
static const _AnsToCmdConnect_type_support_symbol_names_t _AnsToCmdConnect_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, neobotix_usboard_msgs, msg, AnsToCmdConnect)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, neobotix_usboard_msgs, msg, AnsToCmdConnect)),
  }
};
...
{
  return &::neobotix_usboard_msgs::msg::rosidl_typesupport_cpp::AnsToCmdConnect_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, neobotix_usboard_msgs, msg, AnsToCmdConnect)() {
  return get_message_type_support_handle<neobotix_usboard_msgs::msg::AnsToCmdConnect>();
}
