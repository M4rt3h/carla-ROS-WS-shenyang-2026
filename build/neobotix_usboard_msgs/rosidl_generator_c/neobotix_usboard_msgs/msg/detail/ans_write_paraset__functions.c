...
{
  neobotix_usboard_msgs__msg__AnsWriteParaset * msg = (neobotix_usboard_msgs__msg__AnsWriteParaset *)malloc(sizeof(neobotix_usboard_msgs__msg__AnsWriteParaset));
  if (!msg) {
    return NULL;
  }
...
neobotix_usboard_msgs__msg__AnsWriteParaset__Sequence__init(neobotix_usboard_msgs__msg__AnsWriteParaset__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (neobotix_usboard_msgs__msg__AnsWriteParaset *)calloc(size, sizeof(neobotix_usboard_msgs__msg__AnsWriteParaset));
    if (!data) {
      return false;
    }
...
{
  neobotix_usboard_msgs__msg__AnsWriteParaset__Sequence * array = (neobotix_usboard_msgs__msg__AnsWriteParaset__Sequence *)malloc(sizeof(neobotix_usboard_msgs__msg__AnsWriteParaset__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  neobotix_usboard_msgs__msg__AnsWriteParaset__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    neobotix_usboard_msgs__msg__AnsWriteParaset * data =
      (neobotix_usboard_msgs__msg__AnsWriteParaset *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!neobotix_usboard_msgs__msg__AnsWriteParaset__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          neobotix_usboard_msgs__msg__AnsWriteParaset__fini(&data[i]);
        }
        free(data);
        return false;
      }
