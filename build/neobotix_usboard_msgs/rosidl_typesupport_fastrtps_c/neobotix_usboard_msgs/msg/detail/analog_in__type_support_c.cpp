...
#include "neobotix_usboard_msgs/msg/detail/analog_in__rosidl_typesupport_fastrtps_c.h"
...
using _AnalogIn__ros_msg_type = neobotix_usboard_msgs__msg__AnalogIn;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AnalogIn__ros_msg_type * ros_message = static_cast<const _AnalogIn__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: analog_data_ch4_low_byte
  {
    cdr << ros_message->analog_data_ch4_low_byte;
  }

  // Field name: analog_data_ch4_high_bits
  {
    cdr << ros_message->analog_data_ch4_high_bits;
  }

  // Field name: analog_data_ch3_low_byte
  {
    cdr << ros_message->analog_data_ch3_low_byte;
  }

  // Field name: analog_data_ch3_high_bits
  {
    cdr << ros_message->analog_data_ch3_high_bits;
  }

  // Field name: analog_data_ch2_low_byte
  {
    cdr << ros_message->analog_data_ch2_low_byte;
  }

  // Field name: analog_data_ch2_high_bits
  {
    cdr << ros_message->analog_data_ch2_high_bits;
  }

  // Field name: analog_data_ch1_low_byte
  {
    cdr << ros_message->analog_data_ch1_low_byte;
  }

  // Field name: analog_data_ch1_high_bits
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AnalogIn__ros_msg_type * ros_message = static_cast<_AnalogIn__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _AnalogIn__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_neobotix_usboard_msgs__msg__AnalogIn(
...
{
  return max_serialized_size_neobotix_usboard_msgs__msg__AnalogIn(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_AnalogIn = {
...
static rosidl_message_type_support_t _AnalogIn__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AnalogIn,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, neobotix_usboard_msgs, msg, AnalogIn)() {
  return &_AnalogIn__type_support;
}
