...
#include "neobotix_usboard_msgs/msg/detail/sensors__rosidl_typesupport_fastrtps_c.h"
...
#include "neobotix_usboard_msgs/msg/detail/sensor_data__functions.h"  // sensors
...
using _Sensors__ros_msg_type = neobotix_usboard_msgs__msg__Sensors;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: sensors
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, neobotix_usboard_msgs, msg, SensorData
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: sensors
  {
    ...
    if (ros_message->sensors.data) {
      neobotix_usboard_msgs__msg__SensorData__Sequence__fini(&ros_message->sensors);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name sensors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_neobotix_usboard_msgs__msg__SensorData(
...
static uint32_t _Sensors__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_neobotix_usboard_msgs__msg__Sensors(
  ...
  size_t current_alignment)
{
  ...
  // member: sensors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_neobotix_usboard_msgs__msg__SensorData(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_neobotix_usboard_msgs__msg__Sensors(
    full_bounded, 0);
}
