...
#include "neobotix_usboard_msgs/msg/detail/command__rosidl_typesupport_fastrtps_c.h"
...
using _Command__ros_msg_type = neobotix_usboard_msgs__msg__Command;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: set_active_9to16
  {
    cdr << ros_message->set_active_9to16;
  }

  // Field name: set_active_1to8
  {
...
static uint32_t _Command__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_neobotix_usboard_msgs__msg__Command(
...
{
  return max_serialized_size_neobotix_usboard_msgs__msg__Command(
    full_bounded, 0);
}
