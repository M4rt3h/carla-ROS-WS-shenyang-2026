...
#include "neobotix_usboard_msgs/msg/detail/ans_write_paraset__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const neobotix_usboard_msgs::msg::AnsWriteParaset *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<neobotix_usboard_msgs::msg::AnsWriteParaset *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AnsWriteParaset__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const neobotix_usboard_msgs::msg::AnsWriteParaset *>(
...
{
  return max_serialized_size_AnsWriteParaset(full_bounded, 0);
}

static message_type_support_callbacks_t _AnsWriteParaset__callbacks = {
...
static rosidl_message_type_support_t _AnsWriteParaset__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AnsWriteParaset__callbacks,
...
{
  return &neobotix_usboard_msgs::msg::typesupport_fastrtps_cpp::_AnsWriteParaset__handle;
}
