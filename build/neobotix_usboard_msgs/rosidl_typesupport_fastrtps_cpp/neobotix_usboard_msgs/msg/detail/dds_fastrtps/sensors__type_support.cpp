...
#include "neobotix_usboard_msgs/msg/detail/sensors__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const neobotix_usboard_msgs::msg::SensorData &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: sensors
  {
    ...
    for (size_t i = 0; i < size; i++) {
      neobotix_usboard_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  neobotix_usboard_msgs::msg::Sensors & ros_message)
{
  ...
  // Member: sensors
  {
    ...
    for (size_t i = 0; i < size; i++) {
      neobotix_usboard_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: sensors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        neobotix_usboard_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: sensors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        neobotix_usboard_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SensorData(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const neobotix_usboard_msgs::msg::Sensors *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<neobotix_usboard_msgs::msg::Sensors *>(
    untyped_ros_message);
...
{
  return &neobotix_usboard_msgs::msg::typesupport_fastrtps_cpp::_Sensors__handle;
}
