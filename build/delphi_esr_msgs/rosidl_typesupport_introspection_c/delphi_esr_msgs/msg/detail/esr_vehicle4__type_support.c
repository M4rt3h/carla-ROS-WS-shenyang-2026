...
void EsrVehicle4__rosidl_typesupport_introspection_c__EsrVehicle4_init_function(
...
void EsrVehicle4__rosidl_typesupport_introspection_c__EsrVehicle4_fini_function(void * message_memory)
{
  delphi_esr_msgs__msg__EsrVehicle4__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember EsrVehicle4__rosidl_typesupport_introspection_c__EsrVehicle4_message_member_array[11] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers EsrVehicle4__rosidl_typesupport_introspection_c__EsrVehicle4_message_members = {
  "delphi_esr_msgs__msg",  // message namespace
  "EsrVehicle4",  // message name
  11,  // number of fields
  sizeof(delphi_esr_msgs__msg__EsrVehicle4),
  EsrVehicle4__rosidl_typesupport_introspection_c__EsrVehicle4_message_member_array,  // message members
  EsrVehicle4__rosidl_typesupport_introspection_c__EsrVehicle4_init_function,  // function to initialize message memory (memory has to be allocated)
  EsrVehicle4__rosidl_typesupport_introspection_c__EsrVehicle4_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t EsrVehicle4__rosidl_typesupport_introspection_c__EsrVehicle4_message_type_support_handle = {
  0,
  &EsrVehicle4__rosidl_typesupport_introspection_c__EsrVehicle4_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, delphi_esr_msgs, msg, EsrVehicle4)() {
  EsrVehicle4__rosidl_typesupport_introspection_c__EsrVehicle4_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!EsrVehicle4__rosidl_typesupport_introspection_c__EsrVehicle4_message_type_support_handle.typesupport_identifier) {
    EsrVehicle4__rosidl_typesupport_introspection_c__EsrVehicle4_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &EsrVehicle4__rosidl_typesupport_introspection_c__EsrVehicle4_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
