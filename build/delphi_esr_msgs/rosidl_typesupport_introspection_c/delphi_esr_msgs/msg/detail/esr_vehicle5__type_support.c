...
void EsrVehicle5__rosidl_typesupport_introspection_c__EsrVehicle5_init_function(
...
void EsrVehicle5__rosidl_typesupport_introspection_c__EsrVehicle5_fini_function(void * message_memory)
{
  delphi_esr_msgs__msg__EsrVehicle5__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember EsrVehicle5__rosidl_typesupport_introspection_c__EsrVehicle5_message_member_array[10] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers EsrVehicle5__rosidl_typesupport_introspection_c__EsrVehicle5_message_members = {
  "delphi_esr_msgs__msg",  // message namespace
  "EsrVehicle5",  // message name
  10,  // number of fields
  sizeof(delphi_esr_msgs__msg__EsrVehicle5),
  EsrVehicle5__rosidl_typesupport_introspection_c__EsrVehicle5_message_member_array,  // message members
  EsrVehicle5__rosidl_typesupport_introspection_c__EsrVehicle5_init_function,  // function to initialize message memory (memory has to be allocated)
  EsrVehicle5__rosidl_typesupport_introspection_c__EsrVehicle5_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t EsrVehicle5__rosidl_typesupport_introspection_c__EsrVehicle5_message_type_support_handle = {
  0,
  &EsrVehicle5__rosidl_typesupport_introspection_c__EsrVehicle5_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, delphi_esr_msgs, msg, EsrVehicle5)() {
  EsrVehicle5__rosidl_typesupport_introspection_c__EsrVehicle5_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!EsrVehicle5__rosidl_typesupport_introspection_c__EsrVehicle5_message_type_support_handle.typesupport_identifier) {
    EsrVehicle5__rosidl_typesupport_introspection_c__EsrVehicle5_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &EsrVehicle5__rosidl_typesupport_introspection_c__EsrVehicle5_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
