...
static const _EsrEthTx_type_support_symbol_names_t _EsrEthTx_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, delphi_esr_msgs, msg, EsrEthTx)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, delphi_esr_msgs, msg, EsrEthTx)),
  }
};
...
{
  return &::delphi_esr_msgs::msg::rosidl_typesupport_cpp::EsrEthTx_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, delphi_esr_msgs, msg, EsrEthTx)() {
  return get_message_type_support_handle<delphi_esr_msgs::msg::EsrEthTx>();
}
