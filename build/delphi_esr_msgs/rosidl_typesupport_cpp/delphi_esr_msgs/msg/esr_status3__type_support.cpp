...
static const _EsrStatus3_type_support_symbol_names_t _EsrStatus3_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, delphi_esr_msgs, msg, EsrStatus3)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, delphi_esr_msgs, msg, EsrStatus3)),
  }
};
...
{
  return &::delphi_esr_msgs::msg::rosidl_typesupport_cpp::EsrStatus3_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, delphi_esr_msgs, msg, EsrStatus3)() {
  return get_message_type_support_handle<delphi_esr_msgs::msg::EsrStatus3>();
}
