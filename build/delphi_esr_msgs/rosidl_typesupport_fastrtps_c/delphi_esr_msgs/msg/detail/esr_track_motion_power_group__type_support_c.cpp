...
#include "delphi_esr_msgs/msg/detail/esr_track_motion_power_group__rosidl_typesupport_fastrtps_c.h"
...
#include "delphi_esr_msgs/msg/detail/esr_track_motion_power_track__functions.h"  // tracks
...
using _EsrTrackMotionPowerGroup__ros_msg_type = delphi_esr_msgs__msg__EsrTrackMotionPowerGroup;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EsrTrackMotionPowerGroup__ros_msg_type * ros_message = static_cast<const _EsrTrackMotionPowerGroup__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: rolling_count_2
  {
    cdr << ros_message->rolling_count_2;
  }

  // Field name: can_id_group
  {
  ...
  // Field name: tracks
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, delphi_esr_msgs, msg, EsrTrackMotionPowerTrack
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _EsrTrackMotionPowerGroup__ros_msg_type * ros_message = static_cast<_EsrTrackMotionPowerGroup__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: tracks
  {
    ...
    if (ros_message->tracks.data) {
      delphi_esr_msgs__msg__EsrTrackMotionPowerTrack__Sequence__fini(&ros_message->tracks);
    }
...
size_t get_serialized_size_delphi_esr_msgs__msg__EsrTrackMotionPowerGroup(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EsrTrackMotionPowerGroup__ros_msg_type * ros_message = static_cast<const _EsrTrackMotionPowerGroup__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name tracks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_delphi_esr_msgs__msg__EsrTrackMotionPowerTrack(
...
static uint32_t _EsrTrackMotionPowerGroup__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_delphi_esr_msgs__msg__EsrTrackMotionPowerGroup(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_delphi_esr_msgs
size_t max_serialized_size_delphi_esr_msgs__msg__EsrTrackMotionPowerGroup(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: tracks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_delphi_esr_msgs__msg__EsrTrackMotionPowerTrack(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_delphi_esr_msgs__msg__EsrTrackMotionPowerGroup(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_EsrTrackMotionPowerGroup = {
  "delphi_esr_msgs::msg",
...
static rosidl_message_type_support_t _EsrTrackMotionPowerGroup__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EsrTrackMotionPowerGroup,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, delphi_esr_msgs, msg, EsrTrackMotionPowerGroup)() {
  return &_EsrTrackMotionPowerGroup__type_support;
}
