...
#include "delphi_esr_msgs/msg/detail/esr_status1__rosidl_typesupport_fastrtps_c.h"
...
using _EsrStatus1__ros_msg_type = delphi_esr_msgs__msg__EsrStatus1;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EsrStatus1__ros_msg_type * ros_message = static_cast<const _EsrStatus1__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: rolling_count_1
  {
    cdr << ros_message->rolling_count_1;
  }

  // Field name: dsp_timestamp
  {
    cdr << ros_message->dsp_timestamp;
  }

  // Field name: comm_error
  {
    cdr << (ros_message->comm_error ? true : false);
  }

  // Field name: radius_curvature_calc
  {
  ...
  // Field name: yaw_rate_calc
  {
    cdr << ros_message->yaw_rate_calc;
  }

  // Field name: vehicle_speed_calc
  {
  ...
  void * untyped_ros_message)
{
  ...
  _EsrStatus1__ros_msg_type * ros_message = static_cast<_EsrStatus1__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _EsrStatus1__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_delphi_esr_msgs__msg__EsrStatus1(
...
{
  return max_serialized_size_delphi_esr_msgs__msg__EsrStatus1(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_EsrStatus1 = {
  "delphi_esr_msgs::msg",
  "EsrStatus1",
