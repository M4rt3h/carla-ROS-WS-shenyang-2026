...
#include "delphi_esr_msgs/msg/detail/esr_status7__rosidl_typesupport_fastrtps_c.h"
...
using _EsrStatus7__ros_msg_type = delphi_esr_msgs__msg__EsrStatus7;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EsrStatus7__ros_msg_type * ros_message = static_cast<const _EsrStatus7__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _EsrStatus7__ros_msg_type * ros_message = static_cast<_EsrStatus7__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _EsrStatus7__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_delphi_esr_msgs__msg__EsrStatus7(
...
{
  return max_serialized_size_delphi_esr_msgs__msg__EsrStatus7(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_EsrStatus7 = {
  "delphi_esr_msgs::msg",
  "EsrStatus7",
