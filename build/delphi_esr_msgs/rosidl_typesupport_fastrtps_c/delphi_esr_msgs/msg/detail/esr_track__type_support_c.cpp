...
#include "delphi_esr_msgs/msg/detail/esr_track__rosidl_typesupport_fastrtps_c.h"
...
using _EsrTrack__ros_msg_type = delphi_esr_msgs__msg__EsrTrack;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EsrTrack__ros_msg_type * ros_message = static_cast<const _EsrTrack__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: range_accel
  {
    cdr << ros_message->range_accel;
  }

  // Field name: med_range_mode
  {
  ...
  void * untyped_ros_message)
{
  ...
  _EsrTrack__ros_msg_type * ros_message = static_cast<_EsrTrack__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _EsrTrack__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_delphi_esr_msgs__msg__EsrTrack(
...
{
  return max_serialized_size_delphi_esr_msgs__msg__EsrTrack(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_EsrTrack = {
  "delphi_esr_msgs::msg",
  "EsrTrack",
