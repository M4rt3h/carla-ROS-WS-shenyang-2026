...
#include "delphi_esr_msgs/msg/detail/esr_status5__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const delphi_esr_msgs::msg::EsrStatus5 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<delphi_esr_msgs::msg::EsrStatus5 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EsrStatus5__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const delphi_esr_msgs::msg::EsrStatus5 *>(
...
{
  return max_serialized_size_EsrStatus5(full_bounded, 0);
}

static message_type_support_callbacks_t _EsrStatus5__callbacks = {
  "delphi_esr_msgs::msg",
  "EsrStatus5",
...
static rosidl_message_type_support_t _EsrStatus5__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EsrStatus5__callbacks,
...
{
  return &delphi_esr_msgs::msg::typesupport_fastrtps_cpp::_EsrStatus5__handle;
}
