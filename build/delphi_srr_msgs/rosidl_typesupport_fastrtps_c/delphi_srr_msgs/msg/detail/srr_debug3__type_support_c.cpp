...
#include "delphi_srr_msgs/msg/detail/srr_debug3__rosidl_typesupport_fastrtps_c.h"
...
using _SrrDebug3__ros_msg_type = delphi_srr_msgs__msg__SrrDebug3;

static bool _SrrDebug3__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SrrDebug3__ros_msg_type * ros_message = static_cast<const _SrrDebug3__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _SrrDebug3__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _SrrDebug3__ros_msg_type * ros_message = static_cast<_SrrDebug3__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _SrrDebug3__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_delphi_srr_msgs__msg__SrrDebug3(
...
static size_t _SrrDebug3__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_delphi_srr_msgs__msg__SrrDebug3(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_SrrDebug3 = {
  "delphi_srr_msgs::msg",
  "SrrDebug3",
  _SrrDebug3__cdr_serialize,
  _SrrDebug3__cdr_deserialize,
  _SrrDebug3__get_serialized_size,
  _SrrDebug3__max_serialized_size
};

static rosidl_message_type_support_t _SrrDebug3__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SrrDebug3,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, delphi_srr_msgs, msg, SrrDebug3)() {
  return &_SrrDebug3__type_support;
}
