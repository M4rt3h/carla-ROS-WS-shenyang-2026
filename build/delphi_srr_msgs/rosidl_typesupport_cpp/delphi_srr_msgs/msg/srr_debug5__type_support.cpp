...
static const _SrrDebug5_type_support_symbol_names_t _SrrDebug5_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, delphi_srr_msgs, msg, SrrDebug5)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, delphi_srr_msgs, msg, SrrDebug5)),
  }
};
...
{
  return &::delphi_srr_msgs::msg::rosidl_typesupport_cpp::SrrDebug5_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, delphi_srr_msgs, msg, SrrDebug5)() {
  return get_message_type_support_handle<delphi_srr_msgs::msg::SrrDebug5>();
}
