...
#include "delphi_srr_msgs/msg/detail/srr_status3__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const delphi_srr_msgs::msg::SrrStatus3 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<delphi_srr_msgs::msg::SrrStatus3 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SrrStatus3__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const delphi_srr_msgs::msg::SrrStatus3 *>(
...
{
  return max_serialized_size_SrrStatus3(full_bounded, 0);
}

static message_type_support_callbacks_t _SrrStatus3__callbacks = {
  "delphi_srr_msgs::msg",
  "SrrStatus3",
...
static rosidl_message_type_support_t _SrrStatus3__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SrrStatus3__callbacks,
...
{
  return &delphi_srr_msgs::msg::typesupport_fastrtps_cpp::_SrrStatus3__handle;
}
