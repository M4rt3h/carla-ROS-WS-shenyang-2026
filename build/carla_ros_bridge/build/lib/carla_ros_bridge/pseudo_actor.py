...
class PseudoActor(object):
    ...
    def __init__(self, uid, name, parent, node):
        ...
        :param uid: unique identifier for this object 对象的唯一标识
        :type uid: int
        :param name: name identiying this object
        :type name: string
        :param parent: the parent of this 对象的父级，用于嵌套结构和命名空间
        :type parent: carla_ros_bridge.PseudoActor
        :param prefix: the topic prefix to be used for this actor
        :type prefix: string
        :param node: node-handle 节点
    ...
    def get_blueprint_name():
        ...
        :return: name
        """
        #子类必须实现的接口，返回该“伪 actor”的 blueprint名称，否则抛异常。
