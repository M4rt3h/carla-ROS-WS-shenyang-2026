...
{
  mobileye_560_660_msgs__msg__Ahbc * msg = (mobileye_560_660_msgs__msg__Ahbc *)malloc(sizeof(mobileye_560_660_msgs__msg__Ahbc));
  if (!msg) {
    return NULL;
  }
...
mobileye_560_660_msgs__msg__Ahbc__Sequence__init(mobileye_560_660_msgs__msg__Ahbc__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mobileye_560_660_msgs__msg__Ahbc *)calloc(size, sizeof(mobileye_560_660_msgs__msg__Ahbc));
    if (!data) {
      return false;
    }
...
{
  mobileye_560_660_msgs__msg__Ahbc__Sequence * array = (mobileye_560_660_msgs__msg__Ahbc__Sequence *)malloc(sizeof(mobileye_560_660_msgs__msg__Ahbc__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  mobileye_560_660_msgs__msg__Ahbc__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    mobileye_560_660_msgs__msg__Ahbc * data =
      (mobileye_560_660_msgs__msg__Ahbc *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mobileye_560_660_msgs__msg__Ahbc__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          mobileye_560_660_msgs__msg__Ahbc__fini(&data[i]);
        }
        free(data);
        return false;
      }
