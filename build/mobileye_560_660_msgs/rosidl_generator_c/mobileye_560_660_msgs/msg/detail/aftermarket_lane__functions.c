...
{
  mobileye_560_660_msgs__msg__AftermarketLane * msg = (mobileye_560_660_msgs__msg__AftermarketLane *)malloc(sizeof(mobileye_560_660_msgs__msg__AftermarketLane));
  if (!msg) {
    return NULL;
  }
...
mobileye_560_660_msgs__msg__AftermarketLane__Sequence__init(mobileye_560_660_msgs__msg__AftermarketLane__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mobileye_560_660_msgs__msg__AftermarketLane *)calloc(size, sizeof(mobileye_560_660_msgs__msg__AftermarketLane));
    if (!data) {
      return false;
    }
...
{
  mobileye_560_660_msgs__msg__AftermarketLane__Sequence * array = (mobileye_560_660_msgs__msg__AftermarketLane__Sequence *)malloc(sizeof(mobileye_560_660_msgs__msg__AftermarketLane__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  mobileye_560_660_msgs__msg__AftermarketLane__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    mobileye_560_660_msgs__msg__AftermarketLane * data =
      (mobileye_560_660_msgs__msg__AftermarketLane *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mobileye_560_660_msgs__msg__AftermarketLane__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          mobileye_560_660_msgs__msg__AftermarketLane__fini(&data[i]);
        }
        free(data);
        return false;
      }
