...
#include "mobileye_560_660_msgs/msg/detail/lka_reference_points__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const mobileye_560_660_msgs::msg::LkaReferencePoints *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mobileye_560_660_msgs::msg::LkaReferencePoints *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LkaReferencePoints__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mobileye_560_660_msgs::msg::LkaReferencePoints *>(
...
{
  return max_serialized_size_LkaReferencePoints(full_bounded, 0);
}

static message_type_support_callbacks_t _LkaReferencePoints__callbacks = {
...
static rosidl_message_type_support_t _LkaReferencePoints__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LkaReferencePoints__callbacks,
...
{
  return &mobileye_560_660_msgs::msg::typesupport_fastrtps_cpp::_LkaReferencePoints__handle;
}
