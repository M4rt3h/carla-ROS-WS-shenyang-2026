...
#include "mobileye_560_660_msgs/msg/detail/tsr__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const mobileye_560_660_msgs::msg::Tsr *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mobileye_560_660_msgs::msg::Tsr *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Tsr__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mobileye_560_660_msgs::msg::Tsr *>(
...
{
  return max_serialized_size_Tsr(full_bounded, 0);
}

static message_type_support_callbacks_t _Tsr__callbacks = {
...
static rosidl_message_type_support_t _Tsr__handle = {
...
{
  return &mobileye_560_660_msgs::msg::typesupport_fastrtps_cpp::_Tsr__handle;
}
