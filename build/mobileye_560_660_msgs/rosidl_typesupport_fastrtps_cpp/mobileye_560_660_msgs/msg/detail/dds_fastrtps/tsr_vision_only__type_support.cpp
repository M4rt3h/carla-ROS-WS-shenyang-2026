...
#include "mobileye_560_660_msgs/msg/detail/tsr_vision_only__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const mobileye_560_660_msgs::msg::TsrVisionOnly *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mobileye_560_660_msgs::msg::TsrVisionOnly *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TsrVisionOnly__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mobileye_560_660_msgs::msg::TsrVisionOnly *>(
...
{
  return max_serialized_size_TsrVisionOnly(full_bounded, 0);
}

static message_type_support_callbacks_t _TsrVisionOnly__callbacks = {
...
static rosidl_message_type_support_t _TsrVisionOnly__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TsrVisionOnly__callbacks,
...
{
  return &mobileye_560_660_msgs::msg::typesupport_fastrtps_cpp::_TsrVisionOnly__handle;
}
