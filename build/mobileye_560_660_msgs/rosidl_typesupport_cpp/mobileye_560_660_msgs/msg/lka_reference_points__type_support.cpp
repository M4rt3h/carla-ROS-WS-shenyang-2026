...
static const _LkaReferencePoints_type_support_symbol_names_t _LkaReferencePoints_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mobileye_560_660_msgs, msg, LkaReferencePoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mobileye_560_660_msgs, msg, LkaReferencePoints)),
  }
};
...
{
  return &::mobileye_560_660_msgs::msg::rosidl_typesupport_cpp::LkaReferencePoints_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mobileye_560_660_msgs, msg, LkaReferencePoints)() {
  return get_message_type_support_handle<mobileye_560_660_msgs::msg::LkaReferencePoints>();
}
