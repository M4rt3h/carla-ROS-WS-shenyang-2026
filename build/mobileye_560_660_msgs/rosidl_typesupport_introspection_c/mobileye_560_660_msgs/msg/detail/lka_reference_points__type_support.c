...
void LkaReferencePoints__rosidl_typesupport_introspection_c__LkaReferencePoints_init_function(
...
void LkaReferencePoints__rosidl_typesupport_introspection_c__LkaReferencePoints_fini_function(void * message_memory)
{
  mobileye_560_660_msgs__msg__LkaReferencePoints__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember LkaReferencePoints__rosidl_typesupport_introspection_c__LkaReferencePoints_message_member_array[7] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers LkaReferencePoints__rosidl_typesupport_introspection_c__LkaReferencePoints_message_members = {
  ...
  LkaReferencePoints__rosidl_typesupport_introspection_c__LkaReferencePoints_message_member_array,  // message members
  LkaReferencePoints__rosidl_typesupport_introspection_c__LkaReferencePoints_init_function,  // function to initialize message memory (memory has to be allocated)
  LkaReferencePoints__rosidl_typesupport_introspection_c__LkaReferencePoints_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t LkaReferencePoints__rosidl_typesupport_introspection_c__LkaReferencePoints_message_type_support_handle = {
  0,
  &LkaReferencePoints__rosidl_typesupport_introspection_c__LkaReferencePoints_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mobileye_560_660_msgs, msg, LkaReferencePoints)() {
  LkaReferencePoints__rosidl_typesupport_introspection_c__LkaReferencePoints_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  if (!LkaReferencePoints__rosidl_typesupport_introspection_c__LkaReferencePoints_message_type_support_handle.typesupport_identifier) {
    LkaReferencePoints__rosidl_typesupport_introspection_c__LkaReferencePoints_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &LkaReferencePoints__rosidl_typesupport_introspection_c__LkaReferencePoints_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
