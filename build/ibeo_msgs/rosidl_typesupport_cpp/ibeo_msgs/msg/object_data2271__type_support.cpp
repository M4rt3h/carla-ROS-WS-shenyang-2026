...
static const _ObjectData2271_type_support_symbol_names_t _ObjectData2271_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ibeo_msgs, msg, ObjectData2271)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ibeo_msgs, msg, ObjectData2271)),
  }
};
...
{
  return &::ibeo_msgs::msg::rosidl_typesupport_cpp::ObjectData2271_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ibeo_msgs, msg, ObjectData2271)() {
  return get_message_type_support_handle<ibeo_msgs::msg::ObjectData2271>();
}
