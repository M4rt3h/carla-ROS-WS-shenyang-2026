...
#include "ibeo_msgs/msg/detail/untracked_properties__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ibeo_msgs::msg::ContourPointSigma &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  ibeo_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.position_closest_point,
    cdr);
  // Member: object_box_size
  ibeo_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.object_box_size,
    cdr);
  // Member: object_box_size_sigma
  ibeo_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.object_box_size_sigma,
    cdr);
  ...
  ibeo_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.tracking_point_coordinate,
    cdr);
  // Member: tracking_point_coordinate_sigma
  ibeo_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.tracking_point_coordinate_sigma,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: object_box_size_sigma
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ibeo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Point2Dui(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: contour_point_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ibeo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ContourPointSigma(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const ibeo_msgs::msg::UntrackedProperties *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ibeo_msgs::msg::UntrackedProperties *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UntrackedProperties__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ibeo_msgs::msg::UntrackedProperties *>(
...
{
  return max_serialized_size_UntrackedProperties(full_bounded, 0);
}

static message_type_support_callbacks_t _UntrackedProperties__callbacks = {
  "ibeo_msgs::msg",
  "UntrackedProperties",
...
static rosidl_message_type_support_t _UntrackedProperties__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UntrackedProperties__callbacks,
...
{
  return &ibeo_msgs::msg::typesupport_fastrtps_cpp::_UntrackedProperties__handle;
}
