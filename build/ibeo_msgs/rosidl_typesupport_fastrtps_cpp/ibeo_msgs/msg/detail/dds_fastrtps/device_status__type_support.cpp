...
#include "ibeo_msgs/msg/detail/device_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ibeo_msgs::msg::DeviceStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ibeo_msgs::msg::DeviceStatus *>(
    untyped_ros_message);
...
{
  return &ibeo_msgs::msg::typesupport_fastrtps_cpp::_DeviceStatus__handle;
}
