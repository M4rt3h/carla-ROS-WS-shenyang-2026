...
#include "ibeo_msgs/msg/detail/scan_point2205__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ibeo_msgs::msg::ScanPoint2205 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ibeo_msgs::msg::ScanPoint2205 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ScanPoint2205__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ibeo_msgs::msg::ScanPoint2205 *>(
...
{
  return max_serialized_size_ScanPoint2205(full_bounded, 0);
}

static message_type_support_callbacks_t _ScanPoint2205__callbacks = {
  "ibeo_msgs::msg",
  "ScanPoint2205",
...
static rosidl_message_type_support_t _ScanPoint2205__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ScanPoint2205__callbacks,
...
{
  return &ibeo_msgs::msg::typesupport_fastrtps_cpp::_ScanPoint2205__handle;
}
