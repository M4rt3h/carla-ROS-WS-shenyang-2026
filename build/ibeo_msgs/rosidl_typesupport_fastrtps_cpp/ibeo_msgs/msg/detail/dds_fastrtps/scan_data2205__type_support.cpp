...
#include "ibeo_msgs/msg/detail/scan_data2205__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ibeo_msgs::msg::ScannerInfo2205 &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const ibeo_msgs::msg::ScanPoint2205 &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: scanner_info_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ibeo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ScannerInfo2205(
        full_bounded, current_alignment);
    }
  }
  ...
  // Member: scan_point_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ibeo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ScanPoint2205(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const ibeo_msgs::msg::ScanData2205 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ibeo_msgs::msg::ScanData2205 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ScanData2205__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ibeo_msgs::msg::ScanData2205 *>(
...
{
  return max_serialized_size_ScanData2205(full_bounded, 0);
}

static message_type_support_callbacks_t _ScanData2205__callbacks = {
  "ibeo_msgs::msg",
  "ScanData2205",
...
static rosidl_message_type_support_t _ScanData2205__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ScanData2205__callbacks,
...
{
  return &ibeo_msgs::msg::typesupport_fastrtps_cpp::_ScanData2205__handle;
}
