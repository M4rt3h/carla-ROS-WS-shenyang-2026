...
#include "ibeo_msgs/msg/detail/object_data2271__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ibeo_msgs::msg::Object2271 &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: object_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ibeo_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Object2271(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const ibeo_msgs::msg::ObjectData2271 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ibeo_msgs::msg::ObjectData2271 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ObjectData2271__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ibeo_msgs::msg::ObjectData2271 *>(
...
{
  return max_serialized_size_ObjectData2271(full_bounded, 0);
}

static message_type_support_callbacks_t _ObjectData2271__callbacks = {
  "ibeo_msgs::msg",
  "ObjectData2271",
...
static rosidl_message_type_support_t _ObjectData2271__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ObjectData2271__callbacks,
...
{
  return &ibeo_msgs::msg::typesupport_fastrtps_cpp::_ObjectData2271__handle;
}
