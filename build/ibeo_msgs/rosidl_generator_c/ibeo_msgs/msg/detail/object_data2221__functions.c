...
{
  ibeo_msgs__msg__ObjectData2221 * msg = (ibeo_msgs__msg__ObjectData2221 *)malloc(sizeof(ibeo_msgs__msg__ObjectData2221));
  if (!msg) {
    return NULL;
  }
...
ibeo_msgs__msg__ObjectData2221__Sequence__init(ibeo_msgs__msg__ObjectData2221__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ibeo_msgs__msg__ObjectData2221 *)calloc(size, sizeof(ibeo_msgs__msg__ObjectData2221));
    if (!data) {
      return false;
    }
...
{
  ibeo_msgs__msg__ObjectData2221__Sequence * array = (ibeo_msgs__msg__ObjectData2221__Sequence *)malloc(sizeof(ibeo_msgs__msg__ObjectData2221__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  ibeo_msgs__msg__ObjectData2221__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ibeo_msgs__msg__ObjectData2221 * data =
      (ibeo_msgs__msg__ObjectData2221 *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ibeo_msgs__msg__ObjectData2221__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ibeo_msgs__msg__ObjectData2221__fini(&data[i]);
        }
        free(data);
        return false;
      }
