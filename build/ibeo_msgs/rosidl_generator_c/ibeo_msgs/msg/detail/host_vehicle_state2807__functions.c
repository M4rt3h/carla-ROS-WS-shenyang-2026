...
{
  ibeo_msgs__msg__HostVehicleState2807 * msg = (ibeo_msgs__msg__HostVehicleState2807 *)malloc(sizeof(ibeo_msgs__msg__HostVehicleState2807));
  if (!msg) {
    return NULL;
  }
...
ibeo_msgs__msg__HostVehicleState2807__Sequence__init(ibeo_msgs__msg__HostVehicleState2807__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ibeo_msgs__msg__HostVehicleState2807 *)calloc(size, sizeof(ibeo_msgs__msg__HostVehicleState2807));
    if (!data) {
      return false;
    }
...
{
  ibeo_msgs__msg__HostVehicleState2807__Sequence * array = (ibeo_msgs__msg__HostVehicleState2807__Sequence *)malloc(sizeof(ibeo_msgs__msg__HostVehicleState2807__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  ibeo_msgs__msg__HostVehicleState2807__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ibeo_msgs__msg__HostVehicleState2807 * data =
      (ibeo_msgs__msg__HostVehicleState2807 *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ibeo_msgs__msg__HostVehicleState2807__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ibeo_msgs__msg__HostVehicleState2807__fini(&data[i]);
        }
        free(data);
        return false;
      }
