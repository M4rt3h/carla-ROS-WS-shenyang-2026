...
{
  ibeo_msgs__msg__ScanData2205 * msg = (ibeo_msgs__msg__ScanData2205 *)malloc(sizeof(ibeo_msgs__msg__ScanData2205));
  if (!msg) {
    return NULL;
  }
...
ibeo_msgs__msg__ScanData2205__Sequence__init(ibeo_msgs__msg__ScanData2205__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ibeo_msgs__msg__ScanData2205 *)calloc(size, sizeof(ibeo_msgs__msg__ScanData2205));
    if (!data) {
      return false;
    }
...
{
  ibeo_msgs__msg__ScanData2205__Sequence * array = (ibeo_msgs__msg__ScanData2205__Sequence *)malloc(sizeof(ibeo_msgs__msg__ScanData2205__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  ibeo_msgs__msg__ScanData2205__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ibeo_msgs__msg__ScanData2205 * data =
      (ibeo_msgs__msg__ScanData2205 *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ibeo_msgs__msg__ScanData2205__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ibeo_msgs__msg__ScanData2205__fini(&data[i]);
        }
        free(data);
        return false;
      }
