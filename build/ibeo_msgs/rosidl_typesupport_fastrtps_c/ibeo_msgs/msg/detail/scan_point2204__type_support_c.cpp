...
#include "ibeo_msgs/msg/detail/scan_point2204__rosidl_typesupport_fastrtps_c.h"
...
using _ScanPoint2204__ros_msg_type = ibeo_msgs__msg__ScanPoint2204;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ScanPoint2204__ros_msg_type * ros_message = static_cast<const _ScanPoint2204__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _ScanPoint2204__ros_msg_type * ros_message = static_cast<_ScanPoint2204__ros_msg_type *>(untyped_ros_message);
  // Field name: x_position
  {
    cdr >> ros_message->x_position;
  }
...
static uint32_t _ScanPoint2204__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ibeo_msgs__msg__ScanPoint2204(
...
{
  return max_serialized_size_ibeo_msgs__msg__ScanPoint2204(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ScanPoint2204 = {
  "ibeo_msgs::msg",
  "ScanPoint2204",
...
static rosidl_message_type_support_t _ScanPoint2204__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ScanPoint2204,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ibeo_msgs, msg, ScanPoint2204)() {
  return &_ScanPoint2204__type_support;
}
