...
#include "ibeo_msgs/msg/detail/scan_data2205__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/time__functions.h"  // scan_start_time
#include "ibeo_msgs/msg/detail/ibeo_data_header__functions.h"  // ibeo_header
#include "ibeo_msgs/msg/detail/scan_point2205__functions.h"  // scan_point_list
#include "ibeo_msgs/msg/detail/scanner_info2205__functions.h"  // scanner_info_list
...
using _ScanData2205__ros_msg_type = ibeo_msgs__msg__ScanData2205;

static bool _ScanData2205__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ScanData2205__ros_msg_type * ros_message = static_cast<const _ScanData2205__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: scanner_info_list
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ibeo_msgs, msg, ScannerInfo2205
      )()->data);
  ...
  // Field name: scan_point_list
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ibeo_msgs, msg, ScanPoint2205
      )()->data);
...
static bool _ScanData2205__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _ScanData2205__ros_msg_type * ros_message = static_cast<_ScanData2205__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: scanner_info_list
  {
    ...
    if (ros_message->scanner_info_list.data) {
      ibeo_msgs__msg__ScannerInfo2205__Sequence__fini(&ros_message->scanner_info_list);
    }
  ...
  // Field name: scan_point_list
  {
    ...
    if (ros_message->scan_point_list.data) {
      ibeo_msgs__msg__ScanPoint2205__Sequence__fini(&ros_message->scan_point_list);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name scanner_info_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ibeo_msgs__msg__ScannerInfo2205(
  ...
  // field.name scan_point_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ibeo_msgs__msg__ScanPoint2205(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _ScanData2205__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ibeo_msgs__msg__ScanData2205(
  ...
  size_t current_alignment)
{
  ...
  // member: scanner_info_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_ibeo_msgs__msg__ScannerInfo2205(
        full_bounded, current_alignment);
    }
  }
  // member: scan_point_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_ibeo_msgs__msg__ScanPoint2205(
        full_bounded, current_alignment);
    }
  }
...
static size_t _ScanData2205__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ibeo_msgs__msg__ScanData2205(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ScanData2205 = {
  "ibeo_msgs::msg",
  "ScanData2205",
  _ScanData2205__cdr_serialize,
  _ScanData2205__cdr_deserialize,
  _ScanData2205__get_serialized_size,
  _ScanData2205__max_serialized_size
};

static rosidl_message_type_support_t _ScanData2205__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ScanData2205,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ibeo_msgs, msg, ScanData2205)() {
  return &_ScanData2205__type_support;
}
