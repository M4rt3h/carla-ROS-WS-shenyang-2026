...
#include "ibeo_msgs/msg/detail/resolution_info__rosidl_typesupport_fastrtps_c.h"
...
using _ResolutionInfo__ros_msg_type = ibeo_msgs__msg__ResolutionInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ResolutionInfo__ros_msg_type * ros_message = static_cast<const _ResolutionInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: resolution_start_angle
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ResolutionInfo__ros_msg_type * ros_message = static_cast<_ResolutionInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: resolution_start_angle
  {
    cdr >> ros_message->resolution_start_angle;
  }
...
static uint32_t _ResolutionInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ibeo_msgs__msg__ResolutionInfo(
...
{
  return max_serialized_size_ibeo_msgs__msg__ResolutionInfo(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ResolutionInfo = {
  "ibeo_msgs::msg",
  "ResolutionInfo",
...
static rosidl_message_type_support_t _ResolutionInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ResolutionInfo,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ibeo_msgs, msg, ResolutionInfo)() {
  return &_ResolutionInfo__type_support;
}
