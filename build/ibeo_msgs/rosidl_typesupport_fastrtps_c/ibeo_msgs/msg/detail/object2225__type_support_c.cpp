...
#include "ibeo_msgs/msg/detail/object2225__rosidl_typesupport_fastrtps_c.h"
...
#include "ibeo_msgs/msg/detail/point2_df__functions.h"  // absolute_velocity, absolute_velocity_sigma, bounding_box_center, bounding_box_size, contour_point_list, object_box_center, object_box_center_sigma, object_box_size, relative_velocity, relative_velocity_sigma
...
using _Object2225__ros_msg_type = ibeo_msgs__msg__Object2225;

static bool _Object2225__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Object2225__ros_msg_type * ros_message = static_cast<const _Object2225__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  // Field name: bounding_box_size
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->bounding_box_size, cdr))
    {
      return false;
    }
  }
...
static bool _Object2225__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _Object2225__ros_msg_type * ros_message = static_cast<_Object2225__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
  ...
  // Field name: bounding_box_size
  {
    ...
    if (!callbacks->cdr_deserialize(
        cdr, &ros_message->bounding_box_size))
    {
      return false;
    }
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_ibeo_msgs__msg__Point2Df(
    &(ros_message->bounding_box_size), current_alignment);
  // field.name object_box_center
...
static uint32_t _Object2225__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ibeo_msgs__msg__Object2225(
...
static size_t _Object2225__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ibeo_msgs__msg__Object2225(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_Object2225 = {
  "ibeo_msgs::msg",
  "Object2225",
  _Object2225__cdr_serialize,
  _Object2225__cdr_deserialize,
  _Object2225__get_serialized_size,
  _Object2225__max_serialized_size
};

static rosidl_message_type_support_t _Object2225__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Object2225,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ibeo_msgs, msg, Object2225)() {
  return &_Object2225__type_support;
}
