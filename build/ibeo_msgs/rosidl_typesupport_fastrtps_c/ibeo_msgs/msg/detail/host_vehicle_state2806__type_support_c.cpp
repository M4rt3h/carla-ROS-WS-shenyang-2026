...
#include "ibeo_msgs/msg/detail/host_vehicle_state2806__rosidl_typesupport_fastrtps_c.h"
...
using _HostVehicleState2806__ros_msg_type = ibeo_msgs__msg__HostVehicleState2806;

static bool _HostVehicleState2806__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _HostVehicleState2806__ros_msg_type * ros_message = static_cast<const _HostVehicleState2806__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _HostVehicleState2806__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _HostVehicleState2806__ros_msg_type * ros_message = static_cast<_HostVehicleState2806__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _HostVehicleState2806__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ibeo_msgs__msg__HostVehicleState2806(
...
static size_t _HostVehicleState2806__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ibeo_msgs__msg__HostVehicleState2806(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_HostVehicleState2806 = {
  "ibeo_msgs::msg",
  "HostVehicleState2806",
  _HostVehicleState2806__cdr_serialize,
  _HostVehicleState2806__cdr_deserialize,
  _HostVehicleState2806__get_serialized_size,
  _HostVehicleState2806__max_serialized_size
};

static rosidl_message_type_support_t _HostVehicleState2806__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_HostVehicleState2806,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ibeo_msgs, msg, HostVehicleState2806)() {
  return &_HostVehicleState2806__type_support;
}
