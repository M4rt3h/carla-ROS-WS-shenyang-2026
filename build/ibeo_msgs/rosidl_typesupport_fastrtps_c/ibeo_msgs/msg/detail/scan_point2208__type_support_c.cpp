...
#include "ibeo_msgs/msg/detail/scan_point2208__rosidl_typesupport_fastrtps_c.h"
...
using _ScanPoint2208__ros_msg_type = ibeo_msgs__msg__ScanPoint2208;

static bool _ScanPoint2208__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ScanPoint2208__ros_msg_type * ros_message = static_cast<const _ScanPoint2208__ros_msg_type *>(untyped_ros_message);
  // Field name: echo
  {
...
static bool _ScanPoint2208__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _ScanPoint2208__ros_msg_type * ros_message = static_cast<_ScanPoint2208__ros_msg_type *>(untyped_ros_message);
  // Field name: echo
  {
    cdr >> ros_message->echo;
  }
...
static uint32_t _ScanPoint2208__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ibeo_msgs__msg__ScanPoint2208(
...
static size_t _ScanPoint2208__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ibeo_msgs__msg__ScanPoint2208(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ScanPoint2208 = {
  "ibeo_msgs::msg",
  "ScanPoint2208",
  _ScanPoint2208__cdr_serialize,
  _ScanPoint2208__cdr_deserialize,
  _ScanPoint2208__get_serialized_size,
  _ScanPoint2208__max_serialized_size
};

static rosidl_message_type_support_t _ScanPoint2208__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ScanPoint2208,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ibeo_msgs, msg, ScanPoint2208)() {
  return &_ScanPoint2208__type_support;
}
