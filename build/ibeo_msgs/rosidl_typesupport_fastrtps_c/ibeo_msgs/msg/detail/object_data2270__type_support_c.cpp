...
#include "ibeo_msgs/msg/detail/object_data2270__rosidl_typesupport_fastrtps_c.h"
...
#include "ibeo_msgs/msg/detail/object2270__functions.h"  // object_list
...
using _ObjectData2270__ros_msg_type = ibeo_msgs__msg__ObjectData2270;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObjectData2270__ros_msg_type * ros_message = static_cast<const _ObjectData2270__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: object_list
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ibeo_msgs, msg, Object2270
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _ObjectData2270__ros_msg_type * ros_message = static_cast<_ObjectData2270__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: object_list
  {
    ...
    if (ros_message->object_list.data) {
      ibeo_msgs__msg__Object2270__Sequence__fini(&ros_message->object_list);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name object_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ibeo_msgs__msg__Object2270(
...
static uint32_t _ObjectData2270__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ibeo_msgs__msg__ObjectData2270(
  ...
  size_t current_alignment)
{
  ...
  // member: object_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_ibeo_msgs__msg__Object2270(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_ibeo_msgs__msg__ObjectData2270(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ObjectData2270 = {
  "ibeo_msgs::msg",
  "ObjectData2270",
...
static rosidl_message_type_support_t _ObjectData2270__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ObjectData2270,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ibeo_msgs, msg, ObjectData2270)() {
  return &_ObjectData2270__type_support;
}
