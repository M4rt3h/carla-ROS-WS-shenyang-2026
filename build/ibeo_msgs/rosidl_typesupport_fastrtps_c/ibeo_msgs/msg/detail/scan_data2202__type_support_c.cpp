...
#include "ibeo_msgs/msg/detail/scan_data2202__rosidl_typesupport_fastrtps_c.h"
...
#include "ibeo_msgs/msg/detail/scan_point2202__functions.h"  // scan_point_list
...
using _ScanData2202__ros_msg_type = ibeo_msgs__msg__ScanData2202;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ScanData2202__ros_msg_type * ros_message = static_cast<const _ScanData2202__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: scanner_status
  {
    cdr << ros_message->scanner_status;
  }

  // Field name: sync_phase_offset
  {
  ...
  // Field name: scan_point_list
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ibeo_msgs, msg, ScanPoint2202
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _ScanData2202__ros_msg_type * ros_message = static_cast<_ScanData2202__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: scan_point_list
  {
    ...
    if (ros_message->scan_point_list.data) {
      ibeo_msgs__msg__ScanPoint2202__Sequence__fini(&ros_message->scan_point_list);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name scan_point_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ibeo_msgs__msg__ScanPoint2202(
...
static uint32_t _ScanData2202__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ibeo_msgs__msg__ScanData2202(
  ...
  size_t current_alignment)
{
  ...
  // member: scan_point_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_ibeo_msgs__msg__ScanPoint2202(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_ibeo_msgs__msg__ScanData2202(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ScanData2202 = {
  "ibeo_msgs::msg",
  "ScanData2202",
...
static rosidl_message_type_support_t _ScanData2202__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ScanData2202,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ibeo_msgs, msg, ScanData2202)() {
  return &_ScanData2202__type_support;
}
