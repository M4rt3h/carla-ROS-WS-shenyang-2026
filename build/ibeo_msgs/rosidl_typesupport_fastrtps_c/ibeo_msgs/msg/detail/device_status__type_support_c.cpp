...
#include "ibeo_msgs/msg/detail/device_status__rosidl_typesupport_fastrtps_c.h"
...
using _DeviceStatus__ros_msg_type = ibeo_msgs__msg__DeviceStatus;
...
static uint32_t _DeviceStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ibeo_msgs__msg__DeviceStatus(
...
{
  return max_serialized_size_ibeo_msgs__msg__DeviceStatus(
    full_bounded, 0);
}
