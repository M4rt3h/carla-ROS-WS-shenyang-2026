...
#include "carla_msgs/msg/detail/carla_reference_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const carla_msgs::msg::CarlaReferencePoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  carla_msgs::msg::CarlaReferencePoint & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const carla_msgs::msg::CarlaReferencePoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<carla_msgs::msg::CarlaReferencePoint *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CarlaReferencePoint__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const carla_msgs::msg::CarlaReferencePoint *>(
...
{
  return max_serialized_size_CarlaReferencePoint(full_bounded, 0);
}

static message_type_support_callbacks_t _CarlaReferencePoint__callbacks = {
  "carla_msgs::msg",
  "CarlaReferencePoint",
...
static rosidl_message_type_support_t _CarlaReferencePoint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CarlaReferencePoint__callbacks,
...
{
  return &carla_msgs::msg::typesupport_fastrtps_cpp::_CarlaReferencePoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, carla_msgs, msg, CarlaReferencePoint)() {
  return &carla_msgs::msg::typesupport_fastrtps_cpp::_CarlaReferencePoint__handle;
}
