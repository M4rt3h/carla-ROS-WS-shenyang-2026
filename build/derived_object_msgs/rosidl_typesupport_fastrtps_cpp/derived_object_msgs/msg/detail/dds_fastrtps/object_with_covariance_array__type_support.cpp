...
#include "derived_object_msgs/msg/detail/object_with_covariance_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const derived_object_msgs::msg::ObjectWithCovariance &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        derived_object_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObjectWithCovariance(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const derived_object_msgs::msg::ObjectWithCovarianceArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<derived_object_msgs::msg::ObjectWithCovarianceArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ObjectWithCovarianceArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const derived_object_msgs::msg::ObjectWithCovarianceArray *>(
...
{
  return max_serialized_size_ObjectWithCovarianceArray(full_bounded, 0);
}

static message_type_support_callbacks_t _ObjectWithCovarianceArray__callbacks = {
...
static rosidl_message_type_support_t _ObjectWithCovarianceArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ObjectWithCovarianceArray__callbacks,
...
{
  return &derived_object_msgs::msg::typesupport_fastrtps_cpp::_ObjectWithCovarianceArray__handle;
}
