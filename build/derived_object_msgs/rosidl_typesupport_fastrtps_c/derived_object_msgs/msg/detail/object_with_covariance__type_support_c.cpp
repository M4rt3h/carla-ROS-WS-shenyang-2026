...
#include "derived_object_msgs/msg/detail/object_with_covariance__rosidl_typesupport_fastrtps_c.h"
...
#include "derived_object_msgs/msg/detail/solid_primitive_with_covariance__functions.h"  // shape
...
using _ObjectWithCovariance__ros_msg_type = derived_object_msgs__msg__ObjectWithCovariance;

static bool _ObjectWithCovariance__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ObjectWithCovariance__ros_msg_type * ros_message = static_cast<const _ObjectWithCovariance__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: shape
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, derived_object_msgs, msg, SolidPrimitiveWithCovariance
      )()->data);
    if (!callbacks->cdr_serialize(
...
static bool _ObjectWithCovariance__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _ObjectWithCovariance__ros_msg_type * ros_message = static_cast<_ObjectWithCovariance__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_derived_object_msgs__msg__SolidPrimitiveWithCovariance(
...
static uint32_t _ObjectWithCovariance__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_derived_object_msgs__msg__ObjectWithCovariance(
  ...
  size_t current_alignment)
{
  ...
  // member: shape
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_derived_object_msgs__msg__SolidPrimitiveWithCovariance(
        full_bounded, current_alignment);
    }
  }
...
static size_t _ObjectWithCovariance__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_derived_object_msgs__msg__ObjectWithCovariance(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ObjectWithCovariance = {
  "derived_object_msgs::msg",
  "ObjectWithCovariance",
  _ObjectWithCovariance__cdr_serialize,
  _ObjectWithCovariance__cdr_deserialize,
  _ObjectWithCovariance__get_serialized_size,
  _ObjectWithCovariance__max_serialized_size
};

static rosidl_message_type_support_t _ObjectWithCovariance__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ObjectWithCovariance,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, derived_object_msgs, msg, ObjectWithCovariance)() {
  return &_ObjectWithCovariance__type_support;
}
