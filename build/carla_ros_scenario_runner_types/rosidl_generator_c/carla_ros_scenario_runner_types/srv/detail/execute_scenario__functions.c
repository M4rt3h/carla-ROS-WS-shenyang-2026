...
{
  carla_ros_scenario_runner_types__srv__ExecuteScenario_Request * msg = (carla_ros_scenario_runner_types__srv__ExecuteScenario_Request *)malloc(sizeof(carla_ros_scenario_runner_types__srv__ExecuteScenario_Request));
  if (!msg) {
    return NULL;
  }
...
carla_ros_scenario_runner_types__srv__ExecuteScenario_Request__Sequence__init(carla_ros_scenario_runner_types__srv__ExecuteScenario_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_ros_scenario_runner_types__srv__ExecuteScenario_Request *)calloc(size, sizeof(carla_ros_scenario_runner_types__srv__ExecuteScenario_Request));
    if (!data) {
      return false;
    }
...
{
  carla_ros_scenario_runner_types__srv__ExecuteScenario_Request__Sequence * array = (carla_ros_scenario_runner_types__srv__ExecuteScenario_Request__Sequence *)malloc(sizeof(carla_ros_scenario_runner_types__srv__ExecuteScenario_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  carla_ros_scenario_runner_types__srv__ExecuteScenario_Response * msg = (carla_ros_scenario_runner_types__srv__ExecuteScenario_Response *)malloc(sizeof(carla_ros_scenario_runner_types__srv__ExecuteScenario_Response));
  if (!msg) {
    return NULL;
  }
...
carla_ros_scenario_runner_types__srv__ExecuteScenario_Response__Sequence__init(carla_ros_scenario_runner_types__srv__ExecuteScenario_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_ros_scenario_runner_types__srv__ExecuteScenario_Response *)calloc(size, sizeof(carla_ros_scenario_runner_types__srv__ExecuteScenario_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  carla_ros_scenario_runner_types__srv__ExecuteScenario_Response__Sequence * array = (carla_ros_scenario_runner_types__srv__ExecuteScenario_Response__Sequence *)malloc(sizeof(carla_ros_scenario_runner_types__srv__ExecuteScenario_Response__Sequence));
  if (!array) {
    return NULL;
  }
