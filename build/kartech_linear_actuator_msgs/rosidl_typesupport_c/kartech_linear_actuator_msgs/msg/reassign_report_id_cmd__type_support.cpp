...
static const _ReassignReportIdCmd_type_support_symbol_names_t _ReassignReportIdCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kartech_linear_actuator_msgs, msg, ReassignReportIdCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kartech_linear_actuator_msgs, msg, ReassignReportIdCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kartech_linear_actuator_msgs, msg, ReassignReportIdCmd)() {
  return &::kartech_linear_actuator_msgs::msg::rosidl_typesupport_c::ReassignReportIdCmd_message_type_support_handle;
}
