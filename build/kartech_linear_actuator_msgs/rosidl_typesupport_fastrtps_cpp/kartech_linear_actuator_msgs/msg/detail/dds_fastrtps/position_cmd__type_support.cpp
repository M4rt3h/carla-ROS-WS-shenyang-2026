...
#include "kartech_linear_actuator_msgs/msg/detail/position_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const kartech_linear_actuator_msgs::msg::PositionCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kartech_linear_actuator_msgs::msg::PositionCmd *>(
    untyped_ros_message);
...
{
  return &kartech_linear_actuator_msgs::msg::typesupport_fastrtps_cpp::_PositionCmd__handle;
}
