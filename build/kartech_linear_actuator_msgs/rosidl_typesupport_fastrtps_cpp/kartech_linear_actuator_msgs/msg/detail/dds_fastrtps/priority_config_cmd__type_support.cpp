...
#include "kartech_linear_actuator_msgs/msg/detail/priority_config_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const kartech_linear_actuator_msgs::msg::PriorityConfigCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kartech_linear_actuator_msgs::msg::PriorityConfigCmd *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PriorityConfigCmd__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const kartech_linear_actuator_msgs::msg::PriorityConfigCmd *>(
...
{
  return max_serialized_size_PriorityConfigCmd(full_bounded, 0);
}

static message_type_support_callbacks_t _PriorityConfigCmd__callbacks = {
...
static rosidl_message_type_support_t _PriorityConfigCmd__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PriorityConfigCmd__callbacks,
...
{
  return &kartech_linear_actuator_msgs::msg::typesupport_fastrtps_cpp::_PriorityConfigCmd__handle;
}
