...
{
  kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt * msg = (kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt *)malloc(sizeof(kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt));
  if (!msg) {
    return NULL;
  }
...
kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt__Sequence__init(kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt *)calloc(size, sizeof(kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt));
    if (!data) {
      return false;
    }
...
{
  kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt__Sequence * array = (kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt__Sequence *)malloc(sizeof(kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt * data =
      (kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          kartech_linear_actuator_msgs__msg__SoftwareRevisionRpt__fini(&data[i]);
        }
        free(data);
        return false;
      }
