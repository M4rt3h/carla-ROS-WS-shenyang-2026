...
static const _ConfigureOutputsKpKiCmd_type_support_symbol_names_t _ConfigureOutputsKpKiCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kartech_linear_actuator_msgs, msg, ConfigureOutputsKpKiCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kartech_linear_actuator_msgs, msg, ConfigureOutputsKpKiCmd)),
  }
};
...
{
  return &::kartech_linear_actuator_msgs::msg::rosidl_typesupport_cpp::ConfigureOutputsKpKiCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, kartech_linear_actuator_msgs, msg, ConfigureOutputsKpKiCmd)() {
  return get_message_type_support_handle<kartech_linear_actuator_msgs::msg::ConfigureOutputsKpKiCmd>();
}
