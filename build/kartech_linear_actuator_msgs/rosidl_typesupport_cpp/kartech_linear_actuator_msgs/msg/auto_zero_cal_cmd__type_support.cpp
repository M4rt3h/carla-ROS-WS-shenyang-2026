...
static const _AutoZeroCalCmd_type_support_symbol_names_t _AutoZeroCalCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kartech_linear_actuator_msgs, msg, AutoZeroCalCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, kartech_linear_actuator_msgs, msg, AutoZeroCalCmd)),
  }
};
...
{
  return &::kartech_linear_actuator_msgs::msg::rosidl_typesupport_cpp::AutoZeroCalCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, kartech_linear_actuator_msgs, msg, AutoZeroCalCmd)() {
  return get_message_type_support_handle<kartech_linear_actuator_msgs::msg::AutoZeroCalCmd>();
}
