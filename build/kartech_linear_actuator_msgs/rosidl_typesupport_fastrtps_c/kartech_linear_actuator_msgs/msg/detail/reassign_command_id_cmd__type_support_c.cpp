...
#include "kartech_linear_actuator_msgs/msg/detail/reassign_command_id_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _ReassignCommandIdCmd__ros_msg_type = kartech_linear_actuator_msgs__msg__ReassignCommandIdCmd;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ReassignCommandIdCmd__ros_msg_type * ros_message = static_cast<const _ReassignCommandIdCmd__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: command_id_index
  {
    cdr << ros_message->command_id_index;
  }

  // Field name: user_command_id
  {
    cdr << ros_message->user_command_id;
  }

  // Field name: disable_default_command_id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ReassignCommandIdCmd__ros_msg_type * ros_message = static_cast<_ReassignCommandIdCmd__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ReassignCommandIdCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_kartech_linear_actuator_msgs__msg__ReassignCommandIdCmd(
...
{
  return max_serialized_size_kartech_linear_actuator_msgs__msg__ReassignCommandIdCmd(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_ReassignCommandIdCmd = {
...
static rosidl_message_type_support_t _ReassignCommandIdCmd__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ReassignCommandIdCmd,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kartech_linear_actuator_msgs, msg, ReassignCommandIdCmd)() {
  return &_ReassignCommandIdCmd__type_support;
}
