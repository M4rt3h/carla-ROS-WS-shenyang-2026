...
static const _OverlayText_type_support_symbol_names_t _OverlayText_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rviz_2d_overlay_msgs, msg, OverlayText)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rviz_2d_overlay_msgs, msg, OverlayText)),
  }
};
...
{
  return &::rviz_2d_overlay_msgs::msg::rosidl_typesupport_cpp::OverlayText_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rviz_2d_overlay_msgs, msg, OverlayText)() {
  return get_message_type_support_handle<rviz_2d_overlay_msgs::msg::OverlayText>();
}
