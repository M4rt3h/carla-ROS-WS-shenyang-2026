...
{
  carla_ackermann_msgs__msg__EgoVehicleControlTarget * msg = (carla_ackermann_msgs__msg__EgoVehicleControlTarget *)malloc(sizeof(carla_ackermann_msgs__msg__EgoVehicleControlTarget));
  if (!msg) {
    return NULL;
  }
...
carla_ackermann_msgs__msg__EgoVehicleControlTarget__Sequence__init(carla_ackermann_msgs__msg__EgoVehicleControlTarget__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_ackermann_msgs__msg__EgoVehicleControlTarget *)calloc(size, sizeof(carla_ackermann_msgs__msg__EgoVehicleControlTarget));
    if (!data) {
      return false;
    }
...
{
  carla_ackermann_msgs__msg__EgoVehicleControlTarget__Sequence * array = (carla_ackermann_msgs__msg__EgoVehicleControlTarget__Sequence *)malloc(sizeof(carla_ackermann_msgs__msg__EgoVehicleControlTarget__Sequence));
  if (!array) {
    return NULL;
  }
