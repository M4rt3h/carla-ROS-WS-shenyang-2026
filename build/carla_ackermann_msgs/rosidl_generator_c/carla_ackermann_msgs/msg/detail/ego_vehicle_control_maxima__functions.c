...
{
  carla_ackermann_msgs__msg__EgoVehicleControlMaxima * msg = (carla_ackermann_msgs__msg__EgoVehicleControlMaxima *)malloc(sizeof(carla_ackermann_msgs__msg__EgoVehicleControlMaxima));
  if (!msg) {
    return NULL;
  }
...
carla_ackermann_msgs__msg__EgoVehicleControlMaxima__Sequence__init(carla_ackermann_msgs__msg__EgoVehicleControlMaxima__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_ackermann_msgs__msg__EgoVehicleControlMaxima *)calloc(size, sizeof(carla_ackermann_msgs__msg__EgoVehicleControlMaxima));
    if (!data) {
      return false;
    }
...
{
  carla_ackermann_msgs__msg__EgoVehicleControlMaxima__Sequence * array = (carla_ackermann_msgs__msg__EgoVehicleControlMaxima__Sequence *)malloc(sizeof(carla_ackermann_msgs__msg__EgoVehicleControlMaxima__Sequence));
  if (!array) {
    return NULL;
  }
