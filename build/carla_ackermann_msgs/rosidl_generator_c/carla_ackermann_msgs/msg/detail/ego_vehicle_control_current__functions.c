...
{
  carla_ackermann_msgs__msg__EgoVehicleControlCurrent * msg = (carla_ackermann_msgs__msg__EgoVehicleControlCurrent *)malloc(sizeof(carla_ackermann_msgs__msg__EgoVehicleControlCurrent));
  if (!msg) {
    return NULL;
  }
...
carla_ackermann_msgs__msg__EgoVehicleControlCurrent__Sequence__init(carla_ackermann_msgs__msg__EgoVehicleControlCurrent__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_ackermann_msgs__msg__EgoVehicleControlCurrent *)calloc(size, sizeof(carla_ackermann_msgs__msg__EgoVehicleControlCurrent));
    if (!data) {
      return false;
    }
...
{
  carla_ackermann_msgs__msg__EgoVehicleControlCurrent__Sequence * array = (carla_ackermann_msgs__msg__EgoVehicleControlCurrent__Sequence *)malloc(sizeof(carla_ackermann_msgs__msg__EgoVehicleControlCurrent__Sequence));
  if (!array) {
    return NULL;
  }
