...
{
  carla_waypoint_types__msg__CarlaWaypoint * msg = (carla_waypoint_types__msg__CarlaWaypoint *)malloc(sizeof(carla_waypoint_types__msg__CarlaWaypoint));
  if (!msg) {
    return NULL;
  }
...
carla_waypoint_types__msg__CarlaWaypoint__Sequence__init(carla_waypoint_types__msg__CarlaWaypoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (carla_waypoint_types__msg__CarlaWaypoint *)calloc(size, sizeof(carla_waypoint_types__msg__CarlaWaypoint));
    if (!data) {
      return false;
    }
...
{
  carla_waypoint_types__msg__CarlaWaypoint__Sequence * array = (carla_waypoint_types__msg__CarlaWaypoint__Sequence *)malloc(sizeof(carla_waypoint_types__msg__CarlaWaypoint__Sequence));
  if (!array) {
    return NULL;
  }
